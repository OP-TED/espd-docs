...
. The URL where to access the evidence. Will be placed in an element of the object cac:Evidence. See section xref:tech_response.adoc#evidences[Evidences].
. By specifying that the value of the expected data type is an evidence identifier (code EVIDENCE_IDENTIFIER of the Code List ResponseDataType`) the Response will have to contain an evidence supplied in an element of the object cac:Evidence, at the end of the XML Instance. See section xref:tech_response.adoc#evidences[Evidences].
