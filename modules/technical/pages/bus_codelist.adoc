...
In some cases, code lists were removed from ESPD since the information will be retrieved from eForms.

For more details on the code list removed, consult the #Release Notes#.
