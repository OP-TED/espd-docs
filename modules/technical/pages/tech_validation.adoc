...
image:Execution_validation_process_codelists.jpg[Execution of the validation process in code lists,width=600,height=279]
...
From ESPD v4.0.0, UUIDs are replaced by XML Path Like IDs in the data structure, except for the top level Exclusion Grounds and Selection Criteria elements.
//For further details, see xref:tech_common_aspects_for_criteria.adoc[Common Aspects for Criteria]. 
