...
* Identify the business rules, and describe and map the Schematron rules with UBL-2.4 XSD, for each test case;
...
a|2
|XML Implementation Guide (current document) link:https://docs.ted.europa.eu/ESPD-EDM/latest/index.html[Technical HandBook] 
|4.0.0 
...
[loweralpha]
.. Map each of the rules to UBL-2.4 XSD as description;
.. Identify the whole path within UBL-2.4 XSD;
...
[arabic]
. Identification of the test cases from [RD01] and mapping them to the UBL-2.4 XSD:
...
|XSD Schema 
| 
a|XSD filename. It could be ESPD request or ESPD response.
...
| 
a|Description of the business rule from Schematron point of view.
...
|Business requirement |xref:tech_br_request_reqs.adoc#call_for_tender[tbr70-007] |
|XSD Business Rule description | |XSD Business Rule Schematron
...
Then
+
/cac:AdditionalDocumentReference /cac:Attachment /cac:ExternalReference/ cbc:Description multiplicity is two
...
|Business requirement |xref:tech_br_request_reqs.adoc#contracting_body[tbr70-001] |
|XSD Business Rule description | |XSD Business Rule Schematron
...
a|
Business requirement: xref:tech_br_request_reqs.adoc#contracting_body[tbr70-006]
...
|Business requirement: xref:tech_br_request_reqs.adoc#service_provider[tbr70-011] | |
...
|
|Business requirement |xref:tech_br_request_reqs.adoc#list_of_criteria[tbr70-009] |
|XSD Business Rule description | |XSD Business Rule Schematron
...
|
|Business requirement |xref:tech_br_request_reqs.adoc#list_of_criteria[tbr70-010] |
|XSD Business Rule description | |XSD Business Rule Schematron
...
| |
|Business requirement |xref:tech_br_response_reqs.adoc#eo[tbr92-005], xref:tech_br_response_reqs.adoc#eo[tbr92-006], xref:tech_br_response_reqs.adoc#eo[tbr92-007], xref:tech_br_response_reqs.adoc#eval_crit[tbr92-018]
 | |
|XSD Business Rule description | |XSD Business Rule Schematron |
|- | |*No Schematron rule can be implemented* |
|===
...
|
|Business requirement |xref:tech_br_response_reqs.adoc#crit_list[tbr92-016] |
|XSD Business Rule description | |XSD Business Rule Schematron
...
|Business requirement: xref:tech_br_response_reqs.adoc#eo[tbr92-001] | |
...
|Business requirement: xref:tech_br_response_reqs.adoc#eo[tbr92-008]| |
...
a|
Business requirement: xref:tech_br_response_reqs.adoc#eo[tbr92-004]
...
a|
Business requirement: xref:tech_br_response_reqs.adoc#ca[tbr92-012]
...
|Business requirement: xref:tech_br_response_reqs.adoc#service_provider[tbr92-021] | |
...
|Mapping description |All the data regarding the representative of the economic operators is placed in the UBL-2.4 component cac:EconomicOperatorParty/cac:Party/cac:PowerOfAttorney. |
|XSD Path a|
* /cac:EconomicOperatorParty/cac:Party /cac:PowerOfAttorney

|
|Business requirement | xref:tech_br_response_reqs.adoc#reps_eo[tbr92-009]|
|XSD Business Rule description | |XSD Business Rule Schematron
...
| |
|Business requirement |xref:tech_br_response_reqs.adoc#eo[tbr92-006], xref:tech_br_response_reqs.adoc#eo[tbr92-007], xref:tech_br_response_reqs.adoc#eval_crit[tbr92-018]
 | |
|XSD Business Rule description | |XSD Business Rule Schematron |
...
|xref:tech_br_response_reqs.adoc#eo[tbr92-006], xref:tech_br_response_reqs.adoc#eo[tbr92-007], xref:tech_br_response_reqs.adoc#eval_crit[tbr92-018] 
| 
|
...
| |
|Business requirement |xref:tech_br_response_reqs.adoc#eo[tbr92-002], xref:tech_br_response_reqs.adoc#reps_eo[tbr92-010], xref:tech_br_response_reqs.adoc#call_tender_refs[tbr92-013], xref:tech_br_response_reqs.adoc#crit_list[tbr92-016], xref:tech_br_response_reqs.adoc#eval_crit[tbr92-018]
 | |
|XSD Business Rule description | |XSD Business Rule Schematron |
...
| |
|Business requirement |xref:tech_br_response_reqs.adoc#lots[tbr92-014] | |
|XSD Business Rule description | |XSD Business Rule Schematron |
...
| |
|Business requirement |xref:tech_br_request_reqs.adoc[#procurement_lots[tbr70-008] | |
|XSD Business Rule description | |XSD Business Rule Schematron |
...
IDs criterion within /cac:TenderingCriterionProperty 
/cbc:ID which /cac:TenderingCriterion/cbc:CriterionTypeCode +
...
Business requirement: xref:tech_br_request_reqs.adoc#list_of_criteria[tbr70-013]
...
Business requirement: xref:tech_br_response_reqs.adoc#eval_crit[tbr92-018]
| |
...
Business requirement: xref:tech_br_response_reqs.adoc#evidence_link[tbr92-017]
...
a|
Business requirement: xref:tech_br_request_reqs.adoc#general[tbr70-002]

Identifies the earliest version of the UBL 2 schema.

Use the value "2.4". Use also "OASIS-UBL-TC" for the schemeAgencyID attribute.
