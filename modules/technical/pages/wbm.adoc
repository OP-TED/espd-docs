...
|BR-COM-10#2 |/cac:AdditionalDocumentReference /cac:Attachment
...
|BR-COM-10-S10 |/cac:AdditionalDocumentReference /cac:Attachment
...
|BR-COM-10-S20 |/cac:AdditionalDocumentReference /cac:Attachment
/cac:ExternalReference/ cbc:Description |Information (no schematron
rule) | |Below the threshold, information about the publication of the
contract notice in TED MIGHT be provided.

|BR-COM-10-S30 |/cac:AdditionalDocumentReference /cac:Attachment
/cac:ExternalReference/ cbc:Description |Information (no schematron
