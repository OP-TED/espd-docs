...
// Generated from tech_selection_criteria.adoc
// Target section: Criteria


_The buyer shall provide the exclusion grounds and selection criteria for its tendering process as structured information - via ESPD template or structured list of criteria set out in a call for tender._

This chapter on selection criteria provides details on how to implement the formal requirements defined in Directive 2014/24/EU (Articles 58-64) and enforced via ESPD-EDM business rules.

As with the exclusion criteria, we have grouped the selection criteria under different categories. The figure below is intended to identify and list these categories for the selection criteria (branches in text boxes), and specific subgroups within each category.
...
The image below shows the UBL-2.4 schema for TenderingCriterion:
...
See also section "xref:lots-management.adoc[Lots Management]". 
...
See formal requirements related to 'Suitability' criteria in the , and more specifically the requirement 
...
Regarding data structure for Suitability selection criteria
...
Please generate an ESPD Request and ESPD Response documents on https://github.com/OP-TED/ESPD-EDM/tree/v5.0.0/xml-examples[ESPD-EDM XML examples] to see a full example.
...
See formal requirements related to 'Turnover' criteria ESPD in the , and more specifically the requirement 
...
_Figure 20. 'Financial ratio' buyer mock-up_
...
_Figure 21. 'Financial ratio' EO mock-up_
...
_Figure 22. 'Financial ratio' criterion data structure_
////
...
. First financial ratio block: the Criterion Property used to refer to the response by the economic operator. In the ESPD Response document, the ID of this Criterion Property will be used by the element cac:ValidatedCriterionPropertyID as the means to link the response to the question. See section xref:espd-response.adoc[ESPD Response] for more details on this.
...
See formal requirements related to selection criteria in the .
...
_Figure 23. 'Risk indemnity insurance' Buyer REQUIREMENT(s) edition (Procedure with no lots, which actually means 1 Lot)_
...
_Figure 24. 'Risk indemnity insurance' Buyer REQUIREMENT(s) edition (Procedure with more than one Lot)._
...
_Figure 25. 'Economic operator indemnity insurance' EO mock-up_
...
_Figure 26. 'risk indemnity insurance' criterion data structure_
////
...
_Figure 27. 'Other economic or financial requirements' EO mock-up_
...
. The group of REQUIREMENT(s) defines a caption that is kep empty (no name, no description, no value. You will have noticed this also in other criteria. The reason for having this dummy CAPTION is that the UBL-2.4 model requires always at least one cac:TenderingCriterionProperty element instance inside a group or sub-group of properties;
...
_Figure 28. 'Other economic or financial requirements' criterion data structure_
////
=== XML Example
...
[arabic]
. A contract for the acquisition of printers (Lot1) and the maintenance of the printers (Lot2). Your reference is about the maintenance only. Total amount: 1,000,000 â‚¬ (Lot1 + Lot 2). Specific amount: 700,000.00 (Lot2, maintenance).
. Building of a bridge. Total amount: 20,000,000 â‚¬. The reference is only about the asphalt provided for the bridge: specific amount 1,351,145.89 â‚¬.
====
...
_Figure 29. 'References' buyer REQUIREMENT(s) edition mock-up_
...
_Figure 30. 'References' EO mock-up_
...
*_For details on the Schematron-based validation solution see section xref:validation-conformance.adoc[Validation and Conformance].*
====
...
_Figure 31.'References' criterion data structure_
////
...
_Figure 32. 'Abilities (I)' buyer REQUIREMENT edition mock-up_
...
_Figure 33. 'Abilities (I)' EO mock-up_
...
_Figure 34. 'Abilities (I)(Persons)' criterion data structure_
////
...
_Figure 35. 'Abilities (II) (Facilities, ....)' criterion data structure_
...
_Figure 36. 'Abilities (III) (Education)' criterion data structure_
////
...
_Figure 37.  Special requierements check buyer REQUIREMENT edition mock-up_
...
_Figure 38. 'Special requierements check' EO mock-up_
...
_Figure 39. 'Abilities (IV) (Checks)' criterion data structure_
////
...
_Figure 40. 'Abilities (V) (Staff)' criterion data structure_
////
...
_Figure 41. 'Subcontracting proportion' buyer mock-up_
...
_Figure 42. 'Subcontracting proportion' EO mock-up_
...
_Figure 43. 'Subcontracting proportion' criterion data structure_
////
...
_Figure 44. 'Samples and certificates' buyer mock-up_
...
_Figure 45. 'Samples and certificates' EO mock-up_
...
_Figure 46. 'Samples and certificates' criteria data structure_
////
...
_Figure 47. 'Quality Assurance schemes and environmental management standards' buyer mock-up_
...
_Figure 48.'Quality Assurance schemes and environmental management standards' EO mock-up_
...
_Figure 49. 'Quality Assurance schemes and environmental management standards' criteria data structure_
////
...
To cover this possibility, the link:https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32016R0007[ESPD Regulation] introduces a section named "Reduction of the number of qualified candidates" with one criterion that reads as follows:
...
_Figure 50. 'Reduction of candidates' data structure_
////
