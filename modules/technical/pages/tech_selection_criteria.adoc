...
To view the criteria, consult the https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File]. 
...
See Criterion 25 (C25) in the https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File]

==== XML Example

The xml of the criterion is best viewed directly in the xml examples made available in release v4.0.0 on GitHub:

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Request.xml#L2695

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Response.xml#L2709
...
See Criterion 27 (C27) in the https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File]

==== XML Example

The xml of the criterion is best viewed directly in the xml examples made available in release v4.0.0 on GitHub:

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Request.xml#L3064

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Response.xml#L3078
...
_Figure 3. 'General Yearly Turnovers' buyer mock-up for a a common threshold for all years requested._
...
_Figure 4. 'General Yearly Turnovers' Buyer mock-up when applying different turnover per year requested._
...
_Figure 5. 'General Yearly Turnovers' EO mock-up_

=== Data Structure


See Criterion 29 (C29) in the https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File]
...
https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Request.xml#L3448

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Response.xml#L3663
...
_Figure 6. 'Average yearly turnover' Buyer mock-up_
...
_Figure 7. 'Average yearly turnover' EO mock-up_

=== Data Structure

See Criterion 30 (C30) in the https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File]
...
https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Request.xml#L3663

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Response.xml#L3855
...
_Figure 8. 'specific yearly turnover' Buyer mock-up_
...
_Figure 9. 'specific yearly turnover' EO mock-up_
...
See Criterion 32 (C32) in the https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File]

=== XML Example

The xml of the criterion is best viewed directly in the xml examples made available on GitHub:

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Request.xml#L4042

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Response.xml#L4054
...
_Figure 10. 'Specific average turnover' Buyer mock-up_

=== Mock-up - economic operator perspective

image:spec-aver-year-turn-EO.jpg['Specific average turnover' EO mock-up,width=566,height=204]

_Figure 11. 'Specific average turnover' EO mock-up_
...
See Criterion 31 (C31) in the https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File]
...
https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Request.xml#L3841
...
_Figure 12. 'Financial ratio' buyer mock-up_
...
_Figure 13. 'Financial ratio' EO mock-up_
...
See Criterion 34 (C34) in the https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File]
...
https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Request.xml#L4261

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Response.xml#L4275
...
_Figure 14. 'Risk indemnity insurance' Buyer REQUIREMENT(s) edition (Procedure with no lots, which actually means 1 Lot)_
...
_Figure 15. 'Risk indemnity insurance' Buyer REQUIREMENT(s) edition (Procedure with more than one Lot)._
...
_Figure 16. 'Economic operator indemnity insurance' EO mock-up_
...
See Criterion 35 (C35) in the https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File]
...
https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Request.xml#L4415

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Response.xml#L4429
...
_Figure 17. 'Other economic or financial requirements' EO mock-up_
...
See Criterion 36 (C36) in the https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File]
...
https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Request.xml#L4581

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Response.xml#L4595
...
_Figure 18. 'References' buyer REQUIREMENT(s) edition mock-up_
...
_Figure 19. 'References' EO mock-up_
...
See Criterion 37 (C37) in the https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File]


=== XML Example

he xml of the criterion is best viewed directly in the xml examples made available on GitHub:

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Request.xml#L5035

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Response.xml#L5049
...
_Figure 20. 'Abilities (I)' buyer REQUIREMENT edition mock-up_
...
_Figure 21. 'Abilities (I)' EO mock-up_

=== Data Structure


See Criterion 40 (C40) in the https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File]
...
https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Request.xml#L5445

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Response.xml#L5459
...
See Criterion 42 (C42) in the https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File]
...
https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Request.xml#L5961

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Response.xml#L5975
...
See Criterion 47 (C47) in the https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File]
...
https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Request.xml#L6731

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Response.xml#L6745
...
_Figure 22.  Special requirements check buyer REQUIREMENT edition mock-up_
...
_Figure 23. 'Special requirements check' EO mock-up_
...
See Criterion 48 (C48) in the https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File]

=== XML Example

The xml of the criterion is best viewed directly in the xml examples made available on GitHub:

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Request.xml#L6952

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Response.xml#L6966
...
See Criterion 49 (C49) in the https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File]
...
https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Request.xml#L7095

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Response.xml#L7109
...
_Figure 24. 'Subcontracting proportion' buyer mock-up_
...
_Figure 25. 'Subcontracting proportion' EO mock-up_

=== Data Structure

See Criterion 51 (C51) in the https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File]
...
https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Request.xml#L7413

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Response.xml#L7427
...
_Figure 26. 'Samples and certificates' buyer mock-up_
...
_Figure 27. 'Samples and certificates' EO mock-up_

=== Data Structure



See Criterion 52 (C52) in the https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File]
...
https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Request.xml#L7530

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Response.xml#L7544
...
_Figure 28. 'Quality Assurance schemes and environmental management standards' buyer mock-up_
...
_Figure 29.'Quality Assurance schemes and environmental management standards' EO mock-up_
...
See Criterion 54 (C54) in the https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File]
...
https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Request.xml#L7764

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Response.xml#L7778
...
See Criterion 57 (C57) onwards in the https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File]

=== XML example (ESPD-Request)

The xml of the group of criteria is best viewed directly in the xml examples made available on GitHub:

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Request.xml#L8574

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Response.xml#L8588
