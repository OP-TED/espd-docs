...
*Information Requirement*: xref:tech_br_response_reqs.adoc#eo[tbr92-007].
...
See formal requirements related to the economic operators in the e-Sens site: xref:tech_br_response_reqs.adoc#eo[tbr92-001], xref:tech_br_response_reqs.adoc#eo[tbr92-008].
...
See formal requirements related to the representatives of the economic operator in the e-Sens site: xref:tech_br_response_reqs.adoc#service_provider[tbr92-021].
...
See formal requirements related to evidence on the e-Sens site: xref:tech_br_response_reqs.adoc#evidence_link[tbr92-017].
