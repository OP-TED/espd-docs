...
The tables below establish a mapping between the business requirements, the logic layer of the ESPD-EDM and the UBL-2.3 physical layer. They list the elements that are expected in the ESPD Response and provide details on the cardinalities and usage of those elements.
...
|*Definition*: a|
"_A structured electronic business document for providing qualification information in a simplified way through an ESPD when responding to a Call for Tender._" (source: xref:tbr92_reqs.adoc[ESPD Response transaction (Trdm092)]).
...
*Information Requirement*: xref:tbr70_reqs.adoc#general[tbr070-002].
...
*Information Requirement*: xref:tbr70_reqs.adoc#Call for tenders[tbr070-007].
...
*Information Requirement*: xref:tbr92_reqs.adoc#eval_crit[br92-018], xref:tbr92_reqs.adoc#eo[tbr92-007], xref:tbr92_reqs.adoc#eo[tbr92-005], xref:tbr92_reqs.adoc#eo[tbr92-006]].
...
*Information Requirement*: xref:tbr92_reqs.adoc#evidence_link[tbr92-017], xref:tbr92_reqs.adoc#eo[tbr92-007], xref:tbr92_reqs.adoc#eo[tbr92-006].
...
See formal requirements related to the economic operators in the e-Sens site: xref:tbr70_reqs.adoc#eo[tbr092-001], xref:tbr70_reqs.adoc#eo[tbr092-008].
...
*Information Requirement*: xref:tbr92_reqs.adoc#service_provider[tbr092-021].
...
To view the criterion, consult the https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/codelists/ESPD-criterion.xlsx[Criterion File]. The information will be visible in the tab "OTHER-EO-SHELTERED".
...
To view the criterion, consult the https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/codelists/ESPD-criterion.xlsx[Criterion File]. The information will be visible in the tab "OTHER-EO-PQS".
...
To view the criterion, consult the https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/codelists/ESPD-criterion.xlsx[Criterion File]. The information will be visible in the tab "OTHER-EO-GROUPS".
...
To view the criterion, consult the https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/codelists/ESPD-criterion.xlsx[Criterion File]. The information will be visible in the tab "OTHER-EO-NOT_RELIED_ON-ENTITIES".
...
To view the criterion, consult the https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/codelists/ESPD-criterion.xlsx[Criterion File]. The information will be visible in the tab "OTHER-EO-RELIED_ON-ENTITIES".
...
<cac:EconomicOperatorParty>
    <cac:QualifyingParty>
        ...
        <cac:FinancialCapability>
            <cbc:ValueAmount currencyID="EUR">1203000000</cbc:ValueAmount> <15>
        </cac:FinancialCapability>
        <cac:Party>
        <!-- This EO company is NOT an SME -->
        <cbc:IndustryClassificationCode listID="http://publications.europa.eu/resource/authority/economic-operator-size" listAgencyID="OP" listVersionID="20220316-0">LARGE</cbc:IndustryClassificationCode> <13>
    ...
    <cac:EconomicOperatorRole>
        <cbc:RoleCode listID="http://publications.europa.eu/resource/authority/eo-role-type" listAgencyID="OP" listVersionID="20211208-0">group-lead</cbc:RoleCode> <1>
    ...
    <!--Additional Identifier not provided -->
        <cbc:WebsiteURI>https://everis.com/global/en</cbc:WebsiteURI> <12>
        <cac:PartyIdentification>
            <cbc:ID schemeAgencyID="VAT" schemeAgencyName="OP" schemeID="VIES" schemeURI="link:http://ec.europa.eu/taxation_customs/vies/vieshome.do?locale=es" schemeName="VAT number">B82387770</cbc:ID> <10>
        </cac:PartyIdentification>
        <cac:PartyName>
            <cbc:Name>Everis, Spain, S.L.U.</cbc:Name> <2>
        </cac:PartyName>
        <cac:PostalAddress>
...
. Additional identifier. In this example it is not used, thus the element is not displayed in the code snippet above.
...
See formal requirements related to the representatives of the economic operator in the e-Sens site: xref:tbr92_reqs.adoc#service_provider[tbr092-021].
            ...
            <cac:AgentParty>
                ...
                <!-- No element for "street and number" present. The user decided not to provide it -->
                    ...
                    <cac:ResidenceAddress>
                        <!-- No cac:AddressLine element --> <3>
                        <cbc:CityName>Brussels</cbc:CityName> <5>
                        <cbc:PostalZone>1000</cbc:PostalZone> <4>
                        <cac:Country>
                            <cbc:IdentificationCode listID="http://publications.europa.eu/resource/authority/country" listAgencyID="OP" listVersionID="20220928-0">BEL</cbc:IdentificationCode> <6>
...
_Figure 28. cac:EvidenceSupplied XSD element_
...
|*Context of use*: |The economic operator uses it in the ESPD Response document to answer a QUESTION. xref:tbr92_reqs.adoc#eval_crit[tbr92-018], xref:tbr92_reqs.adoc#eo[tbr92-007], xref:tbr92_reqs.adoc#eo[tbr92-005], xref:tbr92_reqs.adoc#eo[tbr92-006].
|===
...
*Information Requirement*: xref:tbr92_reqs.adoc#eval_crit[tbr92-018], xref:tbr92_reqs.adoc#eo[tbr92-007], xref:tbr92_reqs.adoc#eo[tbr92-005], xref:tbr92_reqs.adoc#eo[tbr92-006].
...
<cac:TenderingCriterion>
        ...
        <cbc:Description>The economic operator declares that It meets the objective and non discriminatory criteria or rules to be applied in order to limit the number of candidates in the following way:</cbc:Description> <2>
        ...
        <cac:TenderingCriterionPropertyGroup>
                ...
                <cac:TenderingCriterionProperty>
                        ...
                        <cbc:TypeCode listID="criterion-element-type" listAgencyID="OP" listVersionID="3.3.0">QUESTION</cbc:TypeCode> <1>
                        <cbc:ValueDataTypeCode listID="response-data-type" listAgencyID="OP" listVersionID="3.3.0">INDICATOR</cbc:ValueDataTypeCode> <4>
                </cac:TenderingCriterionProperty>
                <cac:SubsidiaryTenderingCriterionPropertyGroup> <5>
                        ...
                        <cbc:PropertyGroupTypeCode listID="property-group-type" listAgencyID="OP" listVersionID="3.3.0">ONTRUE</cbc:PropertyGroupTypeCode> <6>
                        <cac:TenderingCriterionProperty>
                                <cbc:ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="3.3.0">ffc141f8-5ffe-4492-9066-7ff5dd633583</cbc:ID>
                                <cbc:Description>Please describe them</cbc:Description>
                                <cbc:TypeCode listID="criterion-element-type" listAgencyID="OP" listVersionID="3.3.0">QUESTION</cbc:TypeCode> <7>
                                <cbc:ValueDataTypeCode listID="response-data-type" listAgencyID="OP" listVersionID="3.3.0">DESCRIPTION</cbc:ValueDataTypeCode> <8>
                        </cac:TenderingCriterionProperty>
        ...
        <cac:TenderingCriterionPropertyGroup>
                ...
                <cac:TenderingCriterionProperty>
                        ...
                        <cbc:TypeCode listID="criterion-element-type" listAgencyID="OP" listVersionID="3.3.0">QUESTION</cbc:TypeCode> <3>
...
<cac:TenderingCriterionResponse>
        ...
        <cbc:ValidatedCriterionPropertyID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="3.3.0">c110177c-aa9a-4acd-809a-79a2353a41ef</cbc:ValidatedCriterionPropertyID> <1>
        <cac:ResponseValue>
...
<cac:TenderingCriterionResponse>
        <cbc:ID schemeID="ISO/IEC 9834-8:2008 - 4UUID" schemeAgencyID="OP" schemeVersionID="3.3.0">d47daca4-4a27-4461-9db9-f483d3b7a114</cbc:ID>
        <cbc:ValidatedCriterionPropertyID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="3.3.0">e437cac1-3a89-4f36-bcc7-3219dda49d30</cbc:ValidatedCriterionPropertyID> <3>
        <cac:ResponseValue>
                <cbc:ID schemeID="ISO/IEC 9834-8:2008 - 4UUID" schemeAgencyID="OP" schemeVersionID="3.3.0">de6f1bdd-abce-42f7-b9b8-30c4e7c4c94d</cbc:ID>
                <cbc:Description>This Consortium fulfils all the conditions defined by the buyer in the contract notice, and notably the Consortium is duly registered in the national pre-qualification system of the country of the Consortium lead where all the information about its classification and documentation about its financial standing are up to the date.</cbc:Description> <4>
        </cac:ResponseValue>
</cac:TenderingCriterionResponse>
...
See formal requirements related to evidence in the e-Sens site: xref:tbr92_reqs.adoc#evidence_link[tbr092-017].

=== XSD Schema

Remember that evidence is indirectly linked to responses based on the identifier of the evidence: in the response, the element cac:EvidenceSupplied/cbc:ID contains the identifier set in /QualificationApplicationResponse/cac:Evidence/cbc:ID. See XML example below; see also the example XML file link:{url-tree}/xml-examples/ESPD-Response.xml[ESPD-Response.xml] for an example.
...
_Figure 29. cac:Evidence XSD diagram_
...
_Figure 30. cac:DocumentReference inside cac:Evidence XSD diagram_

=== Mock-ups and data structures

In principle only a few elements are kept in the ESPD Response document about an item of evidence: its Identifier, a URL from where to access its content, a Reference/Code, a Confidentiality indicator, and the Issuer.

This group of data repeats frequently in the many different mock-ups presented in this document. The one below is just one example and will be used to illustrate where the three element go in the XML instance of an item of evidence.

image:Conviction_Participation_criminal organisation_mockup_EO.jpg[Conviction EO mock-up,width=537,height=440]

_Figure 31. Conviction 'Participation in criminal organisation', mock-up (EO perspective)_
...
_Table 44. Elements expected in an item of evidence_
|===
|*Class name*: |cac:Evidence
|*Definition*: |A class to describe an item of supporting evidence for representations of capabilities or the ability to meet tendering requirements, which an economic operator must provide for acceptance into a tendering process.
|*Business rule(s)*: |None
|*File*: |ubl-2.3/xsdrt/common/UBL-CommonAggregateComponents-2.3.xsd
|*Path*: |/QualificationApplicationResponse/cac:Evidence
|*Context of use*: |The economic operator uses it in the ESPD Response document to provide supporting evidence to one or more criteria xref:tbr92_reqs.adoc#evidence_link[tbr092-017]].
|===
...
*Information Requirement*: xref:tbr92_reqs.adoc#evidence_link[tbr092-017]
...
*Information Requirement*: xref:tbr92_reqs.adoc#evidence_link[tbr092-017], xref:tbr92_reqs.adoc#eo[tbr092-007], xref:tbr92_reqs.adoc#eo[tbr092-006]

*Rule*: A code signifying the type of evidence. Could be aligned to e-Certis in the future.
...
*Rule*: None. Could be aligned to e-Certis in the future.
...
This table lists the elements from cac:Evidence/cac:DocumentReference used in the ESPD-EDM:
...
|*Definition*: |A reference to the document of supporting evidence.
|*Business rule(s)*: |None
|*File*: |ubl-2.3/xsdrt/common/UBL-CommonAggregateComponents-2.3.xsd
|*Path*: |/QualificationApplicationResponse/cac:Evidence/cac:DocumentReference
|*Context of use*: |The economic operator uses it in the ESPD Response document to supply the URL of the evidence and the party who issued the document of supporting evidence. xref:tbr92_reqs.adoc#evidence_link[tbr092-017], xref:tbr92_reqs.adoc#additional_info[tbr092-022], xref:tbr92_reqs.adoc#eo[tbr092-017]tbr092-006, xref:tbr92_reqs.adoc#eo[tbr092-007].
|===
...
*Information Requirement*: xref:tbr92_reqs.adoc#evidence_link[tbr092-017], xref:tbr92_reqs.adoc#additional_info[tbr092-022], xref:tbr92_reqs.adoc#eo[tbr092-017]tbr092-006, xref:tbr92_reqs.adoc#eo[tbr092-007]
...
*Information Requirement*: xref:tbr92_reqs.adoc#evidence_link[tbr092-017], xref:tbr92_reqs.adoc#eo[tbr092-017]tbr092-006, xref:tbr92_reqs.adoc#eo[tbr092-007]
...
=== XML snippet 2 different documents of evidence per response

_XML snippet 1.b) different documents of evidence per response_
...
. The name of the issuer of the first document of supporting evidence.
