...
To view the criterion, consult the https://github.com/OP-TED/ESPD-EDM/tree/v5.0.0/criterion/espd-edm.json[espd-edm.json]. The information will be visible in the OT57 "Economic operator is a sheltered workshop".
...
To view the criterion, consult the https://github.com/OP-TED/ESPD-EDM/tree/v5.0.0/criterion/espd-edm.json[espd-edm.json]. The information will be visible in the OT58 "Economic operator registered in a pre qualification system".
////
...
To view the criterion, consult the https://github.com/OP-TED/ESPD-EDM/tree/v5.0.0/criterion/espd-edm.json[espd-edm.json]. The information will be visible in the OT59 "Economic Operator together with others".
////
...
To view the criterion, consult the https://github.com/OP-TED/ESPD-EDM/tree/v5.0.0/criterion/espd-edm.json[espd-edm.json]. The information will be visible in the C07 "Breaching obligation relating to payment of taxes" and C08 "Breaching obligation relating to payment of social security contributions".
////
...
To view the criterion, consult the https://github.com/OP-TED/ESPD-EDM/tree/v5.0.0/criterion/espd-edm.json[espd-edm.json]. The information will be visible in the OT60 "Relied on entities".
////
