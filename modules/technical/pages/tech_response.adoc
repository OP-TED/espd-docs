...
*Information Requirement*: xref:tbr92_reqs.adoc[tbr92-020].
...
See formal requirements related to evidence in the e-Sens site: link:http://wiki.ds.unipi.gr/display/ESPDInt/BIS+41+-+ESPD+V2.1.0#BIS41-ESPDV2.1-tbr092-017[(_tbr092-017_)].
...
|*Context of use*: |The economic operator uses it in the ESPD Response document to provide supporting evidence to one or more criteria link:http://wiki.ds.unipi.gr/display/ESPDInt/BIS+41+-+ESPD+V2.1.0#BIS41-ESPDV2.1-tbr092-017[(_tbr092-017_)].
|===
...
|*Context of use*: |The economic operator uses it in the ESPD Response document to supply the URL of the evidence and the party who issued the document of supporting evidence. link:http://wiki.ds.unipi.gr/display/ESPDInt/BIS+41+-+ESPD+V2.1.0#BIS41-ESPDV2.1-tbr092-017[(_tbr092-017, tbr092-022, tbr092-006, tbr092-007_)].
|===
