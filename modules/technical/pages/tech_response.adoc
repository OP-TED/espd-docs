...
_Figure 28. cac:Evidence XSD diagram_
...
_Figure 29. cac:DocumentReference inside cac:Evidence XSD diagram_
...
_Figure 30. Conviction 'Participation in criminal organisation', mock-up (EO perspective)_
