...
image::https://kroki.io/pikchr/svg/eNqNlU1z2jAQhu_-FRomhyQkqoUxBmZ6MNB2MpNp0zTpJZODsEVQxkgeS4Skv74rIz5k7AAXZOnRu692vfJZgb4iH3e48Lx4iJ5SuRIegt9UvqNWO5kmw8fR7V9WKC7FzeSJPLdQ9rpU2i6OYSgX_B_V9et3hZzxjMGKj3HD4rd3liwb9jtTM64RF29cbR2uuJ4jsUJUo37-jgSSM5RRpbFaIUUXbONS5h83IuUJ1bKoc_L4WHc2KXRBE_1dZikr6swptWQTqpnrsc5d8Im7UuaBL1ids2-JFJDg5FfOCuP-RyGX-U9aD-_qVJtt9sblUh2BZMLSZcHGMt071rPnjYblmeAsMRwshZPFeP3fRuHlWYHmjL_MYRXbQRveq8iseOP11tbvJc34zFQB4sd5ntnhPVO5FIq1AMtSqz6y6laN4DJImVKsjI0Rhnd2MkSpBPMtuyLWKwr8EhsVJTQZbovJxcsdLfTH5th228ruY-ganftXpiUuylqOOo5MtRynafWsVuBomVxDphdMaBi-skR_MSWYMJUUPDeJOSJMsG-Fu0eEb6U-qtW1WqGj9cAEvPyQtXHBNQxOMNW3Qr0jQruyfyrY2ZYickvxxlMmku32lKo5S5tVNkXoOyoTSJVJ1D2bseJ0uWCb-oEj94e_CKoh-afK2KzD6-pTqwRCTicQHF2OiNsOHWgHmLNPa3UrzqDzzn0cXpX9d2GUp1YZrnLYGbSQWtAs22j5uHtpwu_UTCC_jACz60fbeOsYZlqsjGmyNT11Te9ttbJuiFrD12DFGCYNhrfS0wPpqSu9MUrWRmO4DDIuGJoVcoEmcIGYDx2cMSBIz5lAGZtppCUyefbiTgMdVemOoYNammBSpQNDdxvosEp3DR020IMqHRq6V0tDAv0K3TN01EBHVToydL-WDjCp0n1DDxrosEoPgPbKWhPnDo8JbNp98OuIzlEiOEp0awiML10oPAXqHUL-ARQdQu04Tbm57GnW2v-8xX34N41xBV1B4Ar8VLh_SvTBPvQfN3gTiw==[Qualification Application Response UML Diagram,width=600,height=650]
...
*Information Requirement*: xref:tbr92_reqs.adoc#eo[_tbr92-002_].
...
*Information Requirement*: xref:tbr92_reqs.adoc#call_tender_refs[_tbr92-013_].
...
*Information Requirement*: xref:tbr92_reqs.adoc#eo[_tbr92-008_].
...
*Information Requirement*: xref:tbr92_reqs.adoc#eo[_tbr070-007_].
...
*Information Requirement*: xref:tbr92_reqs.adoc#ca[_tbr92-011_].
...
*Information Requirement*: xref:tbr92_reqs.adoc#eo[_tbr92-001_].
...
*Information Requirement*: xref:tbr92_reqs.adoc#lots[_tbr92-014_].
...
The UBL-2.4 element for the role of the economic operator is quite straightforward and typical in UBL: it provides a pair *code + description* (see Code List link:{url-tree}/codelists/gc/EoRoleType.gc[EoRoleType] for the codes and descriptions; see also the XML example below).
...
*Information Requirement*: xref:tbr92_reqs.adoc#eo[tbr92-008] *Rule*: Compulsory use of the Code List link:{url-tree}/codelists/gc/EoRoleType.gc[EoRoleType].
...
. The type of data expected here is a free text bythe EO (for the Response, a DESCRIPTION maps to the UBL-2.4 element cbc:Description, which is an extension of the xsd:String).
...
. Notice this UUID is identical to the cac:TenderingCriterionProperty one. This is the way the UBL-2.4 Qualification Application Response document links each QUESTION(s) to one response (and only one), or viceversa.
. The economic operator states here that it meets the criteria. Notice that the data element is the UBL-2.4 element cbc:ResponseIndicator, which is an ''semantisation'' (a specialisation) of cbc:Indicator and therefore corresponds to the type of data expected by the buyer in the Request (in cbc:ValueDataTypeCode).
