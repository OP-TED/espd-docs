...
_Figure 24. cac:TenderingCriterionResponse XSD element_
...
_Figure 25. cac:ResponseValue XSD element_
...
_Figure 26. cac:ApplicablePeriod XSD element_
...
_Figure 27. cac:EvidenceSupplied XSD element_
