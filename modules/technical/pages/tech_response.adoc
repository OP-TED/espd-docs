...
*Information Requirement*: xref:tech_br_response_reqs.adoc#eo[tbr92-001].
...
*Information Requirement*: xref:tech_br_response_reqs.adoc#eo[tbr92-008] *Rule*: Compulsory use of the Code List link:{url-tree}/codelists/EoRoleType.gc[EoRoleType].
...
*Information Requirement*: xref:tech_br_response_reqs.adoc#eo[tbr92-008].
...
*Information Requirement*: xref:tech_br_response_reqs.adoc#eo[tbr92-004].
...
*Information Requirement*: xref:tech_br_response_reqs.adoc#ca[tbr92-012].
...
*Information Requirement*: xref:tech_br_response_reqs.adoc#service_provider[tbr92-021].
...
|*Context of use*: |The economic operator in the ESPD Response document. Use this element to refer to the natural persons that represent the economic operator. See requirement xref:tech_br_response_reqs.adoc#eval_crit[tbr92-018].
|===
...
*Information Requirement*: xref:tech_br_response_reqs.adoc#reps_eo[tbr92-009] *Rule*: Name of the natural person is mandatory.
...
*Information Requirement*: xref:tech_br_response_reqs.adoc#reps_eo[tbr92-009].
...
*Information Requirement*: xref:tech_br_response_reqs.adoc#reps_eo[tbr92-010].
...
|*Context of use*: |The economic operator uses it in the ESPD Response document to answer a QUESTION. xref:tech_br_response_reqs.adoc#eo[tbr92-005], xref:tech_br_response_reqs.adoc#eo[tbr92-006], xref:tech_br_response_reqs.adoc#eo[tbr92-007], xref:tech_br_response_reqs.adoc#eval_crit[tbr92-018].
|===
...
*Information Requirement*: xref:tech_br_response_reqs.adoc#eo[tbr92-005], xref:tech_br_response_reqs.adoc#eo[tbr92-006], xref:tech_br_response_reqs.adoc#eo[tbr92-007], xref:tech_br_response_reqs.adoc#eval_crit[tbr92-018]
...
*Information Requirement*: xref:tech_br_response_reqs.adoc#eval_crit[tbr92-018]
...
*Information Requirement*: xref:tech_br_response_reqs.adoc#evidence_link[tbr92-017].
...
|*Context of use*: |A class for the economic operator to specify the start date and the end-date when the expected answer to a criterion property is a lapse of time; xref:tech_br_response_reqs.adoc#eval_crit[tbr92-018].
|===
...
|*Context of use*: |Used to refer to one ore more evidences that are present in the QualificationApplicationResponse XML instance; xref:tech_br_response_reqs.adoc#evidence_link[tbr92-017].
|===
...
|*Context of use*: |The economic operator uses it in the ESPD Response document to provide support, in the form of evidence, for one or more criteria xref:tech_br_response_reqs.adoc#evidence_link[tbr92-017].
|===
...
*Information Requirement*: xref:tech_br_response_reqs.adoc#eo[tbr92-006], xref:tech_br_response_reqs.adoc#eo[tbr92-007], xref:tech_br_response_reqs.adoc#evidence_link[tbr92-017]
...
|*Context of use*: |The economic operator uses it in the ESPD Response document to supply the URL of the evidence and the party who issued the evidence document. xref:tech_br_response_reqs.adoc#evidence_link[tbr92-017], xref:tech_br_response_reqs.adoc#additional_info[tbr92-022], xref:tech_br_request_reqs.adoc#contracting_body[tbr70-006], xref:tech_br_request_reqs.adoc#call_for_tender[tbr70-007].
|===
...
*Information Requirement*: xref:tech_br_response_reqs.adoc#evidence_link[tbr92-017], xref:tech_br_response_reqs.adoc#additional_info[tbr92-022], xref:tech_br_request_reqs.adoc#contracting_body[tbr70-006], xref:tech_br_request_reqs.adoc#call_for_tender[tbr70-007]
