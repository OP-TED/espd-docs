...
_Figure 4. cac:EconomicOperatorParty XSD, global view_
...
_Figure 5. cac:QualifyingParty element, XSD_
...
_Figure 6. Role of the economic operator_
...
_Figure 7. The Party of the economic party_
...
_Figure 8. The rich structure of a UBL-2.3 'Classification Scheme' for the representation of taxonomies_

image:UBL-2.3_Capability.jpg[UBL-2.3 'Capability',width=454,height=207]

_Figure 9. The structure of UBL-2.3 'Capability'_

image:UBL-2.3_Completed_Task_for references.jpg[UBL-2.3 Completed Task (used for references),width=291,height=200]

_Figure 10. The structure of the UBL-2.3 Completed Task (used for references)_
...
_Figure 11. The UBL-2.3 Legal Entity Party_
