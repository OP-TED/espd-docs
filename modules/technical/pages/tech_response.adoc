...
|*Definition*: a|
"_A structured electronic business document for providing qualification information in a simplified way through an ESPD when responding to a Call for Tender._" (source: xref:bis41.adoc[_ESPD Response transaction (Trdm092)_]).
...
*Information Requirement*: *Information Requirement*: xref:tbr92_reqs.adoc#versioning[tbr92-020].
...
*Information Requirement*: xref:tbr92_reqs.adoc#eo[tbr92-002].
...
*Information Requirement*: xref:tbr92_reqs.adoc#date_time[tbr92-019].
...
*Information Requirement*: xref:tbr92_reqs.adoc#call_tender_refs[tbr92-013].
...
*Information Requirement*: xref:tbr92_reqs.adoc#eo[tbr92-008].
...
*Information Requirement*: xref:tbr92_reqs.adoc#eo[tbr070-007].
...
*Information Requirement*: xref:tbr92_reqs.adoc#ca[tbr92-011].
...
*Information Requirement*: xref:tbr92_reqs.adoc#eo[tbr92-001].
...
*Information Requirement*: xref:tbr92_reqs.adoc#lots[tbr92-014].
...
*Information Requirement*: xref:tbr92_reqs.adoc#crit_list[tbr92-015], xref:tbr92_reqs.adoc#crit_list[tbr92-016].
...
*Information Requirement*: xref:tbr92_reqs.adoc#eo[tbr92-005], xref:tbr92_reqs.adoc#eo[tbr92-006], xref:tbr92_reqs.adoc#eo[tbr92-007], xref:tbr92_reqs.adoc#eval_crit[tbr92-018].
...
*Information Requirement*: xref:tbr92_reqs.adoc#eo[tbr92-006], xref:tbr92_reqs.adoc#eo[tbr92-007], xref:tbr92_reqs.adoc#evidence_link[tbr92-017].
...
|*cbc:IssueTime* |Time |0..1 |Time when the document was issued by the buyer. |*Information Requirement*: xref:tbr92_reqs.adoc#call_tender_refs[tbr92-013]. *Rule*: If available in the referenced document place here the time of publication by the buyer.

|*cbc:DocumentDescription* |Text |0..1 |Text describing the referenced document. |*Information Requirement*: xref:tbr92_reqs.adoc#call_tender_refs[tbr92-013]. *Rule*: Use the attribute languageID to indicate the language of the text. Use the Code List LanguageCodeEU for the value of the languageID attribute.
...
*Information Requirement*: xref:tbr92_reqs.adoc#eo[tbr92-007].
...
See formal requirements related to the economic operators in the e-Sens site: xref:tbr92_reqs.adoc#eo[tbr92-001], xref:tbr92_reqs.adoc#eo[tbr92-008].
...
*Information Requirement*: xref:tbr92_reqs.adoc#eo[tbr92-008] *Rule*: Compulsory use of the Code List link:{url-tree}/codelists/EoRoleType.gc[EoRoleType].
...
*Information Requirement*: xref:tbr92_reqs.adoc#eo[tbr92-004].
...
*Information Requirement*: xref:tbr92_reqs.adoc#ca[tbr92-012].
...
*Information Requirement*: xref:tbr92_reqs.adoc#service_provider[tbr92-021].
...
See formal requirements related to the representatives of the economic operator in the e-Sens site: xref:tbr92_reqs.adoc#service_provider[tbr92-021].
...
|*Context of use*: |The economic operator in the ESPD Response document. Use this element to refer to the natural persons that represent the economic operator. See requirement xref:tbr92_reqs.adoc#eval_crit[tbr92-018].
|===
...
*Information Requirement*: xref:tbr92_reqs.adoc#reps_eo[tbr92-009] *Rule*: Name of the natural person is mandatory.
...
*Information Requirement*: xref:tbr92_reqs.adoc#reps_eo[tbr92-009].
...
*Information Requirement*: xref:tbr92_reqs.adoc#reps_eo[tbr92-010].
...
|*Context of use*: |The economic operator uses it in the ESPD Response document to answer a QUESTION. xref:tbr92_reqs.adoc#eo[tbr92-005], xref:tbr92_reqs.adoc#eo[tbr92-006], xref:tbr92_reqs.adoc#eo[tbr92-007], xref:tbr92_reqs.adoc#eval_crit[tbr92-018].
|===
...
*Information Requirement*: xref:tbr92_reqs.adoc#eval_crit[tbr92-018]
...
*Information Requirement*: xref:tbr92_reqs.adoc#evidence_link[tbr92-017].
...
|*Context of use*: |A class for the economic operator to specify the start date and the end-date when the expected answer to a criterion property is a lapse of time; xref:tbr92_reqs.adoc#eval_crit[tbr92-018].
|===
...
|*Context of use*: |Used to refer to one ore more evidences that are present in the QualificationApplicationResponse XML instance; xref:tbr92_reqs.adoc#evidence_link[tbr92-017].
|===
...
See formal requirements related to evidence on the e-Sens site: xref:tbr92_reqs.adoc#evidence_link[tbr92-017].
...
|*Context of use*: |The economic operator uses it in the ESPD Response document to provide support, in the form of evidence, for one or more criteria xref:tbr92_reqs.adoc#evidence_link[tbr92-017].
|===
...
|*Context of use*: |The economic operator uses it in the ESPD Response document to supply the URL of the evidence and the party who issued the evidence document. xref:tbr92_reqs.adoc#evidence_link[tbr92-017], xref:tbr92_reqs.adoc#additional_info[tbr92-022], xref:tbr70_reqs.adoc#contracting_body[tbr70-006], xref:tbr70_reqs.adoc#call_for_tender[tbr70-007].
|===
...
*Information Requirement*: xref:tbr92_reqs.adoc#evidence_link[tbr92-017], xref:tbr92_reqs.adoc#additional_info[tbr92-022], xref:tbr70_reqs.adoc#contracting_body[tbr70-006], xref:tbr70_reqs.adoc#call_for_tender[tbr70-007]
