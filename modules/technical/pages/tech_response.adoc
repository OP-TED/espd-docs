...
To view the criterion, consult the https://raw.github.com/OP-TED/ESPD-EDM/v4.0.0/criterion/ESPD-criterion.xlsx[Criterion File]. The information will be visible in the tab "OTHER-EO-SHELTERED".
...
To view the criterion, consult the https://raw.github.com/OP-TED/ESPD-EDM/v4.0.0/criterion/ESPD-criterion.xlsx[Criterion File]. The information will be visible in the tab "OTHER-EO-PQS".
...
To view the criterion, consult the https://raw.github.com/OP-TED/ESPD-EDM/v4.0.0/criterion/ESPD-criterion.xlsx[Criterion File]. The information will be visible in the tab "OTHER-EO-GROUPS".
...
To view the criterion, consult the https://raw.github.com/OP-TED/ESPD-EDM/v4.0.0/criterion/ESPD-criterion.xlsx[Criterion File]. The information will be visible in the tab "EG-Contributions".
...
To view the criterion, consult the https://raw.github.com/OP-TED/ESPD-EDM/v4.0.0/criterion/ESPD-criterion.xlsx[Criterion File]. The information will be visible in the tab "OTHER-EO-RELIED_ON-ENTITIES".
...
To view the criterion, consult the https://raw.github.com/OP-TED/ESPD-EDM/v4.0.0/criterion/ESPD-criterion.xlsx[Criterion File]. The information will be visible in the tab "OTHER-EO-NOT_RELIED_ON-ENTITIES".
