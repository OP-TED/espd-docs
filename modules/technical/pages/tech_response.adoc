...
*Information Requirement*: xref:tech_br_response_reqs.adoc#lots[tbr92-014].
...
*Information Requirement*: xref:tech_br_response_reqs.adoc#crit_list[tbr92-015], xref:tech_br_response_reqs.adoc#crit_list[tbr92-016].
...
|*Business rule(s)*: |None
|*File*: |ubl-2.4/xsdrt/common/UBL-CommonAggregateComponents-2.4xsd
...
|*cbc:IssueTime* |Time |0..1 |Time when the document was issued by the buyer. |*Information Requirement*: xref:tech_br_response_reqs.adoc#call_tender_refs[tbr92-013]. *Rule*: If available in the referenced document place here the time of publication by the buyer.

|*cbc:DocumentDescription* |Text |0..1 |Text describing the referenced document. |*Information Requirement*: xref:tech_br_response_reqs.adoc#call_tender_refs[tbr92-013]. *Rule*: Use the attribute languageID to indicate the language of the text. Use the Code List LanguageCodeEU for the value of the languageID attribute.
