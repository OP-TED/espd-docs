...
For the ESPD Response, the ESPD-EDM uses the UBL-2.4 document named QualificationApplicationResponse.xsd XSD Schema. This schema is available at the following location link:https://docs.oasis-open.org/ubl/os-UBL-2.4/xsdrt/maindoc[ubl-2.4/xsdrt/maindoc] (or the equivalent documented xsd folder).
...
https://github.com/OP-TED/espd-validation-schematron/blob/v5.0.0/ESPDResponse/xsl/ESPD-criterion.xml#L2-L20

For a complete instance of an ESPD Response XML document see the the example file: https://github.com/OP-TED/espd-validation-schematron/blob/v5.0.0/ESPDResponse/xsl/ESPD-criterion.xml[ESPD-criterion.xml]
...
See the XML snippet at the following link (highlighting lines 8574-8625):
https://github.com/OP-TED/espd-validation-schematron/blob/v5.0.0/ESPDRequest/xsl/ESPD-criterion.xml#L8574-L8625
...
See the XML snippet at the following link (highlighting lines ???-???):
https://github.com/OP-TED/espd-validation-schematron/blob/v5.0.0/ESPDResponse/xsl/ESPD-criterion.xml#L???-L???
