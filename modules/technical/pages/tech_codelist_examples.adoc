:doctitle: XML Code List Examples
...
<cac:TenderingCriterionProperty>
        ...
        <cbc:TypeCode listID="criterion-element-type" listVersionID="4.1.0">REQUIREMENT</cbc:TypeCode>
        <cbc:ValueDataTypeCode listID="response-data-type" listVersionID="4.1.0">CODE_BOOLEAN</cbc:ValueDataTypeCode>
...
the requirement issued by the contracting authority -->
        <cbc:ExpectedCode listID="boolean-gui-control-type" listVersionID="4.1.0">RADIO_BUTTON_TRUE</cbc:ExpectedCode>
</cac:TenderingCriterionProperty>
<cac:SubsidiaryTenderingCriterionPropertyGroup>
    ...
    <cbc:PropertyGroupTypeCode listID="property-group-type" listVersionID="4.1.0">ONTRUE</cbc:PropertyGroupTypeCode>
    <cac:TenderingCriterionProperty>
            ...
            <cbc:TypeCode listID="criterion-element-type" listVersionID="4.1.0">REQUIREMENT</cbc:TypeCode>
            <cbc:ValueDataTypeCode listID="response-data-type" listVersionID="4.1.0">DESCRIPTION</cbc:ValueDataTypeCode>
            <!-- No answer is expected
here from the economic operator, as this is a REQUIREMENT issued by the contracting
authority. Hence the element 'cbc:ValueDataTypeCode' contains the type of value of
the requirement issued by the contracting authority -->
...
<cac:SubsidiaryTenderingCriterionPropertyGroup>
        ...
        <cbc:PropertyGroupTypeCode listID="property-group-type" listVersionID="4.1.0">ONFALSE</cbc:PropertyGroupTypeCode>
        <cac:TenderingCriterionProperty>
                ...
                <2>
                <cbc:TypeCode listID="criterion-element-type" listVersionID="4.1.0">REQUIREMENT</cbc:TypeCode>
                <cbc:ValueDataTypeCode listID="response-data-type" listVersionID="4.1.0">QUANTITY</cbc:ValueDataTypeCode>
                <!-- No answer is expected
here from the economic operator, as this is a REQUIREMENT issued by the contracting
authority. Hence the element 'cbc:ValueDataTypeCode' contains the type of value of
the requirement issued by the contracting authority -->
...
<cac:TenderingCriterion>
        ...
        (...)
                ...
                <cac:TenderingCriterionProperty>
                        ...
                        <cbc:TypeCode listID="criterion-element-type"  listVersionID="4.1.0">CAPTION</cbc:TypeCode>
                        <cbc:ValueDataTypeCode listID="response-data-type" listVersionID="4.1.0">NONE</cbc:ValueDataTypeCode>
                </cac:TenderingCriterionProperty>
                (...)
                </cac:TenderingCriterionPropertyGroup>
        </cac:SubTenderingCriterion>
        ...
        <cac:TenderingCriterionPropertyGroup>
                ...
                <cac:TenderingCriterionProperty>
                        ...
                        <cbc:TypeCode listID="criterion-element-type" listVersionID="4.1.0">QUESTION</cbc:TypeCode>
                        <cbc:ValueDataTypeCode listID="response-data-type" listVersionID="4.1.0">INDICATOR</cbc:ValueDataTypeCode>
                </cac:TenderingCriterionProperty>
                (...)
        </cac:TenderingCriterionPropertyGroup>
        (...)
...
<cac:TenderingCriterionProperty>
        ...
        <cbc:TypeCode listID="criterion-element-type" listVersionID="4.1.0">REQUIREMENT</cbc:TypeCode>
        <cbc:ValueDataTypeCode listID="response-data-type" listVersionID="4.1.0">AMOUNT</cbc:ValueDataTypeCode>
        <!-- No answer is expected
        here from the economic operator, as this is a REQUIREMENT issued by the contracting
        authority. Hence the element 'cbc:ValueDataTypeCode' contains the type of value of
        the requirement issued by the contracting authority -->
...
The following xml code is an example of use of code list xref:tech_codelist.adoc#docrefcontent-type-table[docrefcontent-type] in a _cac:AdditionalDocumentReference_ specifying its _cbc:DocumentTypeCode_ value in a ESPDRequest.
...
The following xml code is an example of use of code list xref:tech_codelist.adoc#economic-operator-size-table[economic-operator-size] in a _cac:EconomicOperatorParty_ specifying its _cbc:IndustryClassificationCode_ value in a ESPDResponse.
...
<cac:TenderingCriterionResponse>
    <cbc:ID schemeID="ISO/IEC 9834-8:2008 - 4UUID" schemeAgencyID="OP" schemeVersionID="4.1.0">acb58f0e-0fe4-4372-aa08-60d0c36bfcfe</cbc:ID>
...
<cac:TenderingCriterion>
        ...
        <cac:SubsidiaryTenderingCriterionPropertyGroup>
                ...
                <cbc:PropertyGroupTypeCode listID="property-group-type" listVersionID="4.1.0">ON*</cbc:PropertyGroupTypeCode>
                <cac:TenderingCriterionProperty>
                        ...
                        listVersionID="4.1.0">REQUIREMENT</cbc:TypeCode>
                        <cbc:ValueDataTypeCode listID=
                        "response-data-type" listVersionID="4.1.0">
                ...
                buyer -->
                        ...
                        "financial-ratio-type" listVersionID="4.1.0">R11</cbc:ExpectedCode>
                </cac:TenderingCriterionProperty>
                (...)
        </cac:SubsidiaryTenderingCriterionPropertyGroup>
        (...)
...
<cac:TenderingCriterion>
 <cbc:ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.1.0">6ee55a59-6adb-4c3a-b89f-e62a7ad7be7f</cbc:ID>
        ...
        <cac:TenderingCriterionProperty>
                ...
                <cbc:TypeCode listID="criterion-element-type" listVersionID="4.1.0">REQUIREMENT</cbc:TypeCode>
                <cbc:ValueDataTypeCode listID="response-data-type" listVersionID="4.1.0">CODE</cbc:ValueDataTypeCode>
                <!-- No answer is expected
                here from the economic operator, as this is a REQUIREMENT issued by the contracting
                authority. Hence the element 'cbc:ValueDataTypeCode' contains the type of value of
                the requirement issued by the contracting authority -->
