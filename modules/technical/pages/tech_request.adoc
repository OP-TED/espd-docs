...
<!--2-->    
    <cbc:DocumentTypeCode listID="http://publications.europa.eu/resource/authority/docrefcontent-type" listAgencyID="OP" listVersionID="20220928-0">
      TED_CN
...
<!--3-->        
        <cbc:URI schemeAgencyID="OP">
          http://ted.europa.eu/udl?uri%3DTED:NOTICE:293520-2017:TEXT:EN:HTML%026src%3D0
        </cbc:URI>
<!--4-->        
