...
The figure below shows the XSD Schema defined by UBL-2.4 for the document "Qualification Application Request". This schema replaces the previous scheme form UBL 2.2.
...
From this point in the document, the tables defining classes and its properties refer frequently to business rules. As stated in the xref:bis41.adoc[e-Sens BIS document], "[..] business rules are sets of rules that clarify the content of instances by stating mandatory fields, fixed values (like code lists), dependency between fields in the same object, and dependency between different objects".
...
+
|*Definition 1*: a|
"_A structured electronic business document for requesting qualification information through an ESPD (conform to an ESPD template). Directive 2014/24/EU, Art. 59._" (source: xref:bis41.adoc[_ESPD Request transaction (Trdm070)_]).
...
*Information Requirement*: xref:tbr70_reqs.adoc#general[tbr70-002].
...
*Information Requirement*: xref:tbr70_reqs.adoc#call_for_tender[tbr70-007].
...
*Information Requirement*: xref:tbr70_reqs.adoc#versioning[tbr70-014].
...
*Information Requirement*: xref:tbr70_reqs.adoc#contracting_body[tbr70-001].
...
*Information Requirement*: xref:tbr70_reqs.adoc#list_of_criteria[tbr70-003], xref:tbr70_reqs.adoc#list_of_criteria[tbr70-009].
...
[cols=",",]
|===
|*REQUIREMENT* xref:tbr70_reqs.adoc#call_for_tender[tbr70-007] |*The Buyer must be able to provide information about official journals or gazettes where the procurement procedure is announced. For procurement projects above the threshold it is compulsory to refer to the Contract Notice published in link:https://ted.europa.eu/TED/[TED].*
|===
...
See formal requirements related to the contracting authorities in the e-Sens site: xref:tbr70_reqs.adoc#contracting_body[tbr70-001]*
...
*Information Requirement*: xref:tbr70_reqs.adoc#contracting_body[tbr70-006].
...
[cols=",",]
|===
|*REQUIREMENT* xref:tbr70_reqs.adoc#service_provider[tbr70-011] |*The ESPD request may contain information of identification regarding an ESPD service provider: Name, Party Identification, Endpoint ID.*
|===

Service providers are officially recognised organisations that can supply ESPD Request documents (on behalf of the contracting body) with pre-filled information about the contracting body and additional information (e.g. liability statements, see xref:tbr70_reqs.adoc#additional_documentation[tbr70-012])
...
*Information Requirement*: xref:tbr70_reqs.adoc#service_provider[tbr70-011].
