...
|*File*: |link:{url-tree}/ubl-2.4/xsd/maindoc/[/ubl-2.4/xsd/maindoc/UBL-QualificationApplicationRequest-2.4.xsd]
|===
...
<2> The jurisdiction scope of this document is typified in the Code List docref-content-type (see file link:{url-tree}/codelists/DocRefContentType.gc[/codelists/DocRefContentType.gc] in the distribution package). *Beware that the name and content of this Code List has changed from the previous ESPD-EDM version 2.1.1*.
