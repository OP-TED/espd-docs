...
_Figure 1. QualificationApplicationRequest-2.3 main elements_
...
|*Definition 1*: a|
"_A structured electronic business document for requesting qualification information through an ESPD (conform to an ESPD template). Directive 2014/24/EU, Art. 59._" (source: xref:bis41.adoc[ESPD Request transaction (Trdm070)]).
...
|*cbc:ID* |Identifier |1 |An identifier for this document, normally generated by the system that creates the ESPD document, or the organisation responsible for the document (e.g. the buyer, e.g. a buyer, or the supplier, e.g. an economic operator). The identifier enables referencing the document instance for various purposes including referencing between transactions that are part of the same process. a|
*Information Requirement*: xref:tbr70_reqs.adoc#general[tbr70-002].
...
ESPD definition: this component indicates if the document is an original or a copy, i.e., has or has not been generated or sent previously.  +
...
//[Edit this diagram](https://niolesk.top/#https://kroki.io/pikchr/svg/eNqtVMtu2zAQvOsrFooPsdMopBTGSIBcGqS9pAjQXnwrKImW2TCkS1KxP7-kXpZsWcihJ0Mecmc4uzszDY-AopjLQHDJdjyvv0kQfH1d_cYPoD6oAC4_uOGpYMEKPUCFRAau4PIaRQn5giJM5oFlewshhmtY_XiBn-xvyYwNIVUih0wJpSEVNHsDausKQUC1VrsGQ3tC79OcQK52EvBipmGt1TusENgNk6B5sbEw05WuuNEVPu8zURquJBRalTI3cPnNFaNCgFDW-Ktg6DubhyD-lMYeXgJrbqcUxBGZ1pC0Gn4xwTLrNWSaW6Y5nSSrKlYFnIUVlaMZlD_SU7HdtmwvygIOJ0oL6pj92ba8a9FiSBEvxklIS_LUPAQwUJlDfMxXt_r01Eibyfl3H8saF3XXf_kZJQ00Qn_3v7xZnvEm-ZQ3yai4ZRBc5F6cH9OUF1BLdQMtC_D7aKqt7FvH_NbhyO3cHAoFuJ7SDaO5v3PfDKpD0BA5ALj_N07IOBDH5BOlhkC87NPfDu9kQhlvkNvMztemNQf_6haQriXltgoj993kEToJpCZ1okh2wWO2Sho2kTzozOJ3PmNUxxvy0TbvRdJpDOA2I8OWGLZMw_Nr1Xc_mO73Ruk2E8LvLqi2oNYec3F1SDB_vsuS8cD6B1sEy7c=)
_Figure 3. Overview of new lot management approach_
...
The Figure below is a mock-up of how to collect the data expected to reference publications on official gazettes or journals. This mechanism can, of course, also be used for contracts below the https://single-market-economy.ec.europa.eu/single-market/public-procurement/legal-rules-and-implementation/thresholds_en[threshold].

image:Publications_mock-up.jpg[Publications mock-up,width=500,height=459]

_Figure 4. Publications, mock-up_
...
_Figure 5. cac:DocumentReference, XSD diagram_
...
_Figure 6. Associated class cac:ExternalReference, XSD diagram_
...
*Rule*: For the ESPD-EDM it is compulsory to use the Code List "docref-content-type". See the example below on how to specify the OJS Contract Notice. If, for other documents, the type of document is not available in this list, provide the code "Other" and describe the content in the element DocumentType.
...
_Figure 7. Data about the procurer, mock-up_
...
_Figure 8. cac:ContractingParty XSD Schema, global vision_
...
_Figure 9. cac:Party XSD Schema, global vision_
...
_Figure 10. cac:PostalAddress, XSD Schema_
...
_Figure 11. cac:Contact, XSD Schema_
...
|*Definition*: |Contracting body address information.
|*Business rule(s)*: |None
|*File*: |ubl-2.3/xsdrt/common/UBL-CommonAggregateComponents-2.3.xsd
|*Path*: |/QualificationApplicationRequest/
...
_Figure 12. cac:ServiceProvider XSD Schema_
...
_Figure 13. cac:ServiceProvider_
...
_Figure 14. cac:ServiceProvider/cac:Party elements expected for the service provider_
...
Please generate an ESPD Request and ESPD Response documents on https://docs.ted.europa.eu/espd-demo/[ESPD Demo Site] to see full example. The XML snippet below shows how an example of how to supply the expected data for the service provider:

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Response.xml#L21-L46
