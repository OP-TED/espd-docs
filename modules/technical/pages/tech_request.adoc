...
[[espd_request_business_requirements]]
...
[[espd_request_xsd_schema]]
== ESPD Request XSD Schema

The ESPD-EDM uses the UBL-2.4 document named QualificationApplicationRequest.xsd XSD Schema. This schema can be found under the GitHub folder https://github.com/OP-TED/ESPD-EDM/tree/master/ubl-2.4/xsdrt/maindoc[ubl-2.4/xsdrt/maindoc] (or the equivalent documented xsd folder).

The figure below shows a diagram representing the UBL-2.4 XSD Schema. Only the first level components of the schema are shown. The inner sub-elements and sub-classes are covered in detail in the following sub-sections of this document.
...
[[espd_request_cardinalities]]
== ESPD Request cardinalities

The UBL-2.4 Schema is quite flexible as, except for in a few cases, all the elements are optional.
...
//[Edit this diagram](https://niolesk.top/#https://kroki.io/pikchr/svg/eNqNlUFP4zAQhe_5FVbEAcpi4jQpbKU9pO2uhIRWLAt7QRzcZEKNUrtrOxT-PePGLaRNgV6a2s_fex5P3ANNfpCIxkIGQTYkd4VayoDgZ6qeSXicT_Ph7ejyH2gjlLyY3LH7kFSPtbF-8kqrUlTw8xny2nZLWkOlsETIJ2E2JkthZ0QuCbfkfPFMJFElqbix1CyJ4XPwlLFavFzIQuTcKn0XUbptc3vb4T1W0mqe21-qKkB_IPiNTl3UC2NqmHAL7T10pWfxB_FXnBvRbfJW3o7JKw1PQtXmE5HKoag1jFXxLup9EIyGq5yYL8OwBabNaPN9TJLegSYzEA8znKXNQzBuFoR_al6J0tUbXbPFovKP1_C_BmNDVFWFR4480rMYTR15VRtqnPeIYn9NhqRQmDj0M7KZMRiSeVOS83y4ORQhH664ti_rvfplS78OyAk5jL659j1aHcoobmFcUbAkc5AWHx8ht6euVhMwuRYLt5dPwQMP7rfANyCxmzDdWAuLD5-CGI08KPkiKDx1gt0dXCp7DSVokDmcNm9XuN818a5py3WCUIfcgNamBTczKPbjvnvcoIX7Kx4ktxjza5iY9hsMnnrEPQlBrYZi9Kw3Yu2uirGrcMz_augeDtjMhxFN3ZGdpUeOPPVkvL2cZUjMnFfVmhXRpOfs32jOKFo54Gjz0_dv4-GG5dKFZpvQ03bod0s9tm3RGfgEo7jAbE_gDXq6g5620eugrAma4TtVCQmk1GpOJvgeursd99hnxM5AkgpKS6wirs5BFu9Rn22rY6fud6oZZdvqvlMne9Tp-ZY6ceq0Ux3TaJudOvVgjzrZVg9QHawqzFoXUMZw0dvfUpci7lBQ2muL-ruiaEeU7IqOs6IQ7jLi1a72Q1j6FcfBe9ErDZh0tg==)
_Figure 2. ESPD-EDM 'QualificationApplicationRequest', UML diagram_

Comparing both figures, it can be observed that:

[arabic]
. The cardinalities of the root common basic components, such as cbc:ID, cbc:UUID, differ in the ESPD from in UBL-2.4;
. Similarly, the cardinalities of aggregate components like cac:ContractingParty and cac:TenderingCriterion also differ in the ESPD from in UBL-2.4.
...
The tables below establish a mapping between the business requirements, the logic layer of the ESPD-EDM, and the UBL-2.4 physical layer. They list the elements that are expected in the ESPD Request and provide details on the cardinalities and usage of those elements.
...
From this point in the document, the tables defining classes and its properties refer frequently to business rules as sets of rules that clarify the content of instances by stating mandatory fields, fixed values (like code lists), dependency between fields in the same object, and dependency between different objects.

Information requirement:
Note that *all these documents share the same business rule identifiers* (e.g. tbrxx-yyy for Business Requirement Identifiers in ESPDInt, and BR-Type-Id#n for the Test Cases technical rules).
====

The mapping between the business requirements, the logic layer of the ESPD-EDM, and the UBL-2.4 physical layer:
...
+
|*Definition 1*: a|
"_A structured electronic business document for requesting qualification information through an ESPD (conform to an ESPD template). Directive 2014/24/EU, Art. 59._" (source: xref:tech_br_espd_profile.adoc[_ESPD Request transaction (Trdm070)_]).
...
|*File*: |link:https://docs.oasis-open.org/ubl/os-UBL-2.4/xsdrt/maindoc/[/ubl-2.4/xsd/maindoc/UBL-QualificationApplicationRequest-2.4.xsd]
|===
...
*Information Requirement*: xref:tech_br_request_reqs.adoc#general[tbr70-002].
...
*Information Requirement*: xref:tech_br_request_reqs.adoc#call_for_tender[tbr70-007].
...
*Information Requirement*: xref:tech_br_request_reqs.adoc#versioning[tbr70-014].
...
*Information Requirement*: xref:tech_br_request_reqs.adoc#contracting_body[tbr70-001].
...
*Information Requirement*: xref:tech_br_request_reqs.adoc#list_of_criteria[tbr70-003], xref:tech_br_request_reqs.adoc#list_of_criteria[tbr70-009].
...
*Rule*: *For procurement procedures above the threshold it is compulsory to make reference to the Contract Notice of the procedure published in TED*. See section xref:tech_response.adoc#reference_to_publications[Reference to publications and to the ESPD Request] for a complete example.
...
XXXX: set of 4 digits. By default, the numbering should be increased by 1 from one object to the following one of the same category and a leading 0 should be used to satisfy the 4 digit format if required
|===

_Figure 4. Lot Identifiers according to eForms schema_

[[eu_notice_publications]]
== EU and notice publications

[cols="1,4",options="header"]
|===
|*REQUIREMENT* xref:tech_br_request_reqs.adoc#call_for_tender[tbr70-007] |*The Buyer must be able to provide information about official journals or gazettes where the procurement procedure is announced. For procurement projects above the threshold it is compulsory to refer to the Contract Notice published in link:https://ted.europa.eu/TED/[TED].*
|===
...
_Figure 5. Publications, mock-up_
...
The class used for this, cac:AdditionalDocumentReference ''is a'' cac:DocumentReference class defined in the UBL-2.4 Common Aggregate Components library).
...
_Figure 6. cac:DocumentReference, XSD diagram_
...
_Figure 7. Associated class cac:ExternalReference, XSD diagram_
...
Please generate an ESPD Request and ESPD Response documents on https://docs.ted.europa.eu/espd-demo/[ESPD Demo Site] to see full example and how to use the cac:AdditionalDocumentReference in the ESPDRequest XML document to refer to a Contract Notice published in TED and on a national procurement board.

<1> For TED Notices, the Publications Office Official Journal Supplement number must be used in its original format [][][][]/S [][][]-[][][][][][], e.g. 2017/S 142-293520. Notice that the schemeAgencyID is OP (OP standing for 'Publications Office').
<2> . *BeThe jurisdiction scope of this document is typified in the Code List docref-content-type (see file link:{url-tree}/codelists/DocRefContentType.gc[/codelists/DocRefContentType.gc] in the distribution package)ware that the name and content of this Code List has changed from the previous ESPD-EDM version 2.1.1*.
<3> The actual content is never embedded in the ESPD documents. Rather the content is always referenced from its original source (alignment with the Once-Only-Principle).
<4> The title of the CN must be placed in the FileName field of the attachment. UBL does not provide a placeholder for the title of the document.
<5> If publication on TED is at the ESPD Request preparation time, and the procurer does not yet have the OJS number, they can receive a temporary CN identifier (Received Notice Number). To save this number in the DocumentReference component, two cbc:Description elements must be created, and the second one used for the Received Notice Number. If you do not have a description for the CN then use dummy content for the first description, e.g. <cbc:Description>_</cbc:/Description>.
<6> schemeAgencyID is used in this example to specify that the national Agency that created this reference to the national publication (e.g., "PLACE" to refer to the ID of the national electronic board where the CN was published). The pattern of the ID is the one created by the Spanish buyer.
<7> In this case, the code NOJCN means 'Contract Notice (CN) published on a National Government Official Journal' (see file link:{url-tree}/codelists/DocRefContentType.gc[/codelists/DocRefContentType.gc] in the distribution package).
...
The contracting body must be identified, hence information about the party is required, such as party name, identification, endpoint id, buyer profile and country.
...
Therefore software applications may make use of the richness of UBL-2.4 to collect data about the buyer contact, end-point, and other possible data in the ESPD.

image:Procurer_identification_mockup.jpg[Procurer identification,width=600,height=100]

_Figure 8. Data about the procurer, mock-up_

=== XSD Schema

The UBL-2.4 model provides a component that fits the purpose of holding data about the procurer: the common aggregate component cac:ContractingParty.
...
_Figure 9. cac:ContractingParty XSD Schema, global vision_
...
image::https://kroki.io/blockdiag/svg/eNrtld1q2zAUx-_9FMJjsIGWLwrtWjZI0wQCaVealg1GMYp0YmtVpEyS0zil93uKPdyeZEfOnDYtbQjbzaB39vn86_jno5Ey_EpIlpKbqF4npywFUvfAMy05U-VTYuF7Ds7XMj9RpD95EJLIYHF1zvgps75IvgyPkiHPYMKSVJkRU69bjZl00ujat2lK3vRkmlsgzfc1gjn7ZRLBJLJMomSZRZY5b4OsIXjipkyTCXgr5xEh5WtyLYXPyAeys3ewsmUg08yjsdkqjQLGLFc-GRvtnVxA8OwcRFFqTT4lC7AmWT7eRFFcijkvphCTry5j0xCNTi1AjMyckqphs9Wgzhcq-AVzGQhKuFHG4nv86rDZ67Wa8SV2uTN2G71eezdGWxyTdx9JDHO_f3E46M496HBSF1MS8xHfP2b2qsMs9LXACXtj7zvaHsM9hj_yfoaRkx4uzvqVZWBScwZjsKA59I8qc1eLqZHa31mwVu68LTqKOSfHoS526BgR5iBkOIA2Gi4r6avv1hdBTJVQlqtcJ2yynk2JYiNQYRiNWu3Xj5_xWr0B02mOJK2KGOeZagthwbmVMStcoG5g_nR8Xt45m5dQwZqyAaRMdVG3L7YR2EGAGPfPtATrHkjaULKd4vhKTU9XHYKdSQ6n1sykALuMXs3oGuynMTJhrIZi7ZTt3GfGysXjOW0Q1ZOaaS5x9pwj-s8cGD-ODNWZQvaGyF4lYGhC_jHgYkHdY6k2k4B16f_yT9At_gD6N3TTrVim65zSNSrpI-Lov-SLPsEO3Z6UKLqNqqW_3LfeIDYCHK2WOZkxlQORDhfxXiBytayxzsRocW9TNyi5uxIauJNfIHuBbMP13toNoNz-BsH-BnY=[cac:Party XSD Schema global vision,width=400,height=950]
//image:cacParty_XSD_Schema_global vision.jpg[cac:Party XSD Schema, global vision,width=254,height=718]
//[Edit this diagram](https://niolesk.top/#https://kroki.io/blockdiag/svg/eNrtld1q2zAUx-_9FMJjsIGWLwrtWjZI0wQCaVealg1GMYp0YmtVpEyS0zil93uKPdyeZEfOnDYtbQjbzaB39vn86_jno5Ey_EpIlpKbqF4npywFUvfAMy05U-VTYuF7Ds7XMj9RpD95EJLIYHF1zvgps75IvgyPkiHPYMKSVJkRU69bjZl00ujat2lK3vRkmlsgzfc1gjn7ZRLBJLJMomSZRZY5b4OsIXjipkyTCXgr5xEh5WtyLYXPyAeys3ewsmUg08yjsdkqjQLGLFc-GRvtnVxA8OwcRFFqTT4lC7AmWT7eRFFcijkvphCTry5j0xCNTi1AjMyckqphs9Wgzhcq-AVzGQhKuFHG4nv86rDZ67Wa8SV2uTN2G71eezdGWxyTdx9JDHO_f3E46M496HBSF1MS
//[Edit this diagram](https://niolesk.top/#https://kroki.io/blockdiag/svg/eNrVVNtq20AQfdZ-xaC-tKDasggkOLTQxBak9BKwC4USxEoaS9ustKp23doJfu9X9OP6JZ2VLPmStPStVE87Zw5zOTOjWKrkNhU8g3s2HMI1zxCGBpO8FAmXzSuq8csStRnkppBwVRxRImERPUx4cqlKwxMTfZxNolmSY8EHn6sMnoYiW9YIwWgAxBpvaR4QD1reM5t8hgZ0xUso0NRixQAaM_omUpPDCzg5O--xHEWWGwJHQQOmuOBLaaIFxdbiDq3npPGwrFbLCu6wVlH7vGcsUVLVxHGfTP0wfHXqnjPmuvD8Jbi2wmtem7ULn1JhSaUq8Yb8e56OuG3lUWrvs2RcmfGHizfTlcFSC1Vq16MIcTK-mnSvd7zA7v1axXNhZG9PsKLEBZamQ-Yoscop3T6w4KvOnEpMTK1oRm-5kEcFPqyvKUCZNho535sc60tVFEs7ZUMVH4TwQPIYpVXQHwx-fv_hUtetugtRa9Mr7fRKx5Int6SzY0iLnf5h6NNncZ3zys5NihKtadbSminXOaYEOA4N0zkonTnMaTNpTFSZ7tJasrulzdcVUvVdfKKUKaaxWnnQrdbo1PcOE3qwq_FiFIbByL2hfbJx7fewLev5XWvWd9ReAz3eYlP7v14Y7692glk5NszZsE13wa2kRtGepKi97jLhK5dLBKHpYs_srfXzoL9PQbPbDSPwPejvO_BJ9r3T8w4Pz_tflPrz_gUnts3NL0kRt4w=)
_Figure 12. cac:Contact, XSD Schema_
...
*Information Requirement*: xref:tech_br_request_reqs.adoc#contracting_body[tbr70-006].
...
*Rule*: When possible, use the VAT identification of the contracting body (see the link:https://ec.europa.eu/taxation_customs/vies/[VIES] platform for a EU cross-border national VAT number verification system). When not possible, a different identifier may be used. The code list link:{url-tree}/codelists/EOIDType.gc[EOIDType] may be used to indicate the type of identifier used as a value of the schemeID attribute, e.g. schemeID="VAT").
...
[cols="1,4",options="header"]
|===
|*REQUIREMENT* xref:tech_br_request_reqs.adoc#service_provider[tbr70-011] |*The ESPD request may contain information of identification regarding an ESPD service provider: Name, Party Identification, Endpoint ID.*
|===

Service providers are officially recognised organisations that can supply ESPD Request documents (on behalf of the contracting body) with pre-filled information about the contracting body and additional information (e.g. liability statements, see xref:tech_br_request_reqs.adoc#additional_documentation[tbr70-012])
...
Since the 2.1.1 does not include the cac:ServiceProvider as a 'document root component'. Instead, it uses the UBL-2.4 cac:ContractingParty/cac:Party associated class cac:ServiceProviderParty.

=== XSD Schema

image::https://kroki.io/blockdiag/svg/eNrVWd1u4kYUvsZPceTetNLUARppo0StRDZBitSLSKRSpc0KGfuAp2vGrmfIz65y36fow_VJesYeG_wDZAUCwwXYZ87MfGfm_DMJI--Lz90ZfLPOzuDenSGcKfQCwT03TJ_GCf69QKmcQM1DuJtXWMZcU-SZ53ojTJ64h_dJ9MR9TMZ_jm7GIy_Auev8Fc_gxyGfLRKEft8B4r6ssAOxQ8b-k8YyQgUydgXMUSX8xQJIX8fP3FcB_ArnF1cFLUA-CxQRe_2U6OPUXYRqPI2Ekvwr6pHzdMSaJdEihq-YROPs8ZtleVEYJcRj_3DbHQ4HH-wry7Jt-Pk3sDXQezdRrzZ88r
//image:cacService_provider_Party_elements.jpg[service provider's 'Party' elements,width=506,height=524]
//[Edit this diagram](https://niolesk.top/#https://kroki.io/blockdiag/svg/eNrVVNtO3DAQfV5_xSh9ASlkL4UWQalEgZVWoi0Cqj5QFHnj2cTFa6e2Q3dBvPcr-nH9ktrJJnsBqpa-tHlYrc94LmdmfIZCJVeM0xRuSbsNJzRFaFtMMskTKsp_scYvBRobZXYsYDBeuRJzj5h2QpMz1Nc8wTjX6poz1PEJ1XYao8AxSmuiz3kKa32eFhqh9zwC57Iz8zmZufgwO6Ub1G6AkxwTiwxGSoPNEEzlA3WedV_6GVowOZUwRqv5hACUx_grZzaDPdjc3m2wDHmaWQd2eyXIcEQLYeORcvn4DXrLZmkhqVZFDjeoVVz9vSUkUcJVsgfBs6NOv7__MtglJAhg4zUETfnVMYqiIHToMNl5S_XVAdU4kMz1zSq9aNi31lHlSt6zfsSh4RY_nA5q5Fil6hRHqFEmODis4SPJcsWlnSMuVmGsnh4Iagwf-bguw4FiGMAF456BVBIvyWrVzXHAfFW1Zxm3Nr2j4-UwIQg6ROHb0omiH9--Bw8HPqYyLdzGNNGUsVTsM6bRmAbMpsZv17Gapf7Ngs_p5CzJ8AmluUlBQMgDJcGrDQjW3ksxLZcvUYV0TQW-1JtPMnF9BT7f1nVXgrFT4ZeJUZMhu9wl5NHeVjz81A5XyJLVptc3743A3a12dMS1sc2-toIHEp5Pc-9sMpr7Ct1VyZAN1SSE-sX0up1wmUEI89V_0-33e93AkWq1YI4PBU2uggq0OLFzh36_476gfFazr84uuMQlfClrFaz8qTtEWnekNSNrMFGSrbL1zfmPOZaz9Szvam2rKrbKTZqhCWvNgmsqinLxur1tr0INXafqY9eYBa6dEBrl63Ucq1qfyuWHi0YqS9sTV36WXSqLC6m3FnO_cIeafvU-7ymqL2D-Qv9FCQ3_QCfDv5G-8BF9--Vab_kR3v0EwtZ-KQ==)
_Figure 15. cac:ServiceProvider/cac:Party elements expected for the service provider_
...
*Information Requirement*: xref:tech_br_request_reqs.adoc#service_provider[tbr70-011].
...
*Rule*: An identifier for the service provider must always be provided. Compulsory use of the attribute SchemeAgencyID. When possible use the VAT identification of the service provider (see the VIES platform for a EU cross-border national VAT number verification system). See XML example below. The code list link:{url-tree}/codelists/EOIDType.gc[EOIDType] may be used to indicate the type of identifier used as a value of the schemeID attribute, e.g. schemeID="VAT").
...
<!--2-->
  ...
  <cac:PartyName>
    <cbc:Name>Ministerio de Defensa</cbc:Name>
  </cac:PartyName>
  <cac:PostalAddress>
    <cac:Country>
...
<!--3-->
    <cac:PartyName>
      <cbc:Name>Registro Oficial de Licitadores y Empresas Clasificadas (ROLECE)</cbc:Name>
    </cac:PartyName>
    <cac:PostalAddress>
<!--4-->
      <cac:Country>
...
----
<1> ContractingParty non-nandatory elements have been omitted for the sake of brevity.
