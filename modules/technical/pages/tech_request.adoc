...
+
|*Definition 1*: a|
"_A structured electronic business document for requesting qualification information through an ESPD (conform to an ESPD template). Directive 2014/24/EU, Art. 59._" source: xref:tbr70_reqs.adoc#general[tbr070-002].
...
*Information Requirement*: xref:tbr70_reqs.adoc#call_for_tender[tbr070-007].
...
*Information Requirement*: xref:tbr70_reqs.adoc#versioning[tbr070-014].
...
*Information Requirement*: xref:tbr70_reqs.adoc#contracting_body[tbr070-001].
...
*Information Requirement*: xref:tbr70_reqs.adoc#list_of_criteria[tbr070-003], xref:tbr70_reqs.adoc#list_of_criteria[tbr070-009].
...
[cols=",",]
|===
|*REQUIREMENT* xref:tbr70_reqs.adoc#call_for_tender[tbr070-007] |*The Buyer must be able to provide information about official journals or gazettes where the procurement procedure is announced. For procurement projects above the threshold it is compulsory to refer to the Contract Notice published in link:https://ted.europa.eu/TED/[TED].*
|===
...
See formal requirements related to the contracting authorities in the e-Sens site: xref:tbr70_reqs.adoc#contracting_body[tbr070-001]*
...
*Information Requirement*: xref:tbr70_reqs.adoc#contracting_body[tbr070-006].
...
[cols=",",]
|===
|*REQUIREMENT* xref:tbr70_reqs.adoc#service_provider[tbr070-011] |*The ESPD request may contain information of identification regarding an ESPD service provider: Name, Party Identification, Endpoint ID.*
|===

Service providers are officially recognised organisations that can supply ESPD Request documents (on behalf of the contracting body) with pre-filled information about the contracting body and additional information (e.g. liability statements, see xref:tbr70_reqs.adoc#additional_documentation[tbr070-012])
...
*Information Requirement*: xref:tbr70_reqs.adoc#service_provider[tbr070-011].
...
The XML snippet below shows how an example of how to supply the expected data for the service provider and is best viewed directly in the xml examples made available in release v3.3 on GitHub:

https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/xml-examples/ESPD-Request.xml#L36

https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/xml-examples/ESPD-Response.xml#L36
