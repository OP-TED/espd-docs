...
Please generate an ESPD Request and ESPD Response documents on https://docs.ted.europa.eu/espd-demo/[ESPD Demo Site] to see full example. The XML snippet below shows an example of how to supply the expected data for the service provider:
