...
*Information Requirement*: xref:tbr70_reqs.adoc#Contracting body[tbr070-001].
...
[cols=",",]
|===
|*REQUIREMENT* xref:tbr70_reqs.adoc#Call for tenders[tbr070-007] |*The Buyer must be able to provide information about official journals or gazettes where the procurement procedure is announced. For procurement projects above the threshold it is compulsory to refer to the Contract Notice published in link:https://ted.europa.eu/TED/[TED].*
|===
...
See formal requirements related to the contracting authorities in the e-Sens site: xref:tbr70_reqs.adoc#Contracting body[tbr070-001]*
...
*Information Requirement*: xref:tbr70_reqs.adoc#Contracting body[tbr070-006].
...
[cols=",",]
|===
|*REQUIREMENT* xref:tbr70_reqs.adoc#ESPD service provider[tbr070-011] |*The ESPD request may contain information of identification regarding an ESPD service provider: Name, Party Identification, Endpoint ID.*
|===

Service providers are officially recognised organisations that can supply ESPD Request documents (on behalf of the contracting body) with pre-filled information about the contracting body and additional information (e.g. liability statements, see xref:tbr70_reqs.adoc#Additional documentation[tbr070-012])
...
*Information Requirement*: xref:tbr70_reqs.adoc#ESPD service provider[tbr070-011].
