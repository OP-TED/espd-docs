...
*Rule*: Each Criterion is defined in e-Certis and must use the UUID supplied by e-Certis. See also the spreadsheets https://raw.github.com/OP-TED/ESPD-EDM/v4.0.0/criterion/ESPD-criterion.xlsx[_ESPD-criterion_].
...
*Rule*: Compulsory use of codes coming from e-Certis, which are also used in the spreadsheets https://raw.github.com/OP-TED/ESPD-EDM/v4.0.0/criterion/ESPD-criterion.xlsx[_ESPD-criterion_], e.g. crime-org, corruption, chain-manage
...
*Rule*: The name should match the one from e-Certis, which should be the same as in the in the spreadsheets https://raw.github.com/OP-TED/ESPD-EDM/v4.0.0/criterion/ESPD-criterion.xlsx[_ESPD-criterion_], e.g. 'Convictions', 'Corruption', 'Fraud', 'Financial ratio', 'Subcontracting proportion'etc.).
...
See also the spreadsheet https://raw.github.com/OP-TED/ESPD-EDM/v4.0.0/criterion/ESPD-criterion.xlsx[_ESPD-criterion_].
...
To view the an example of the data structure, consult the https://raw.github.com/OP-TED/ESPD-EDM/v4.0.0/criterion/ESPD-criterion.xlsx[Criterion File]. The information will be visible in the tab "EG-Convictions", and others.
...
The https://raw.github.com/OP-TED/ESPD-EDM/v4.0.0/criterion/ESPD-criterion.xlsx[Criterion File] illustrates how the ONTRUE and ONFALSE SUBGROUPS of a Criterion of type "Contributions (exclusion grounds)" relate to each of its ''closer QUESTION'' of type INDICATOR. See the "element code" column.
...
The https://raw.github.com/OP-TED/ESPD-EDM/v4.0.0/criterion/ESPD-criterion.xlsx[Criterion File], e.g., in criterion 36, demonstrates an example of the radio button class in use.
