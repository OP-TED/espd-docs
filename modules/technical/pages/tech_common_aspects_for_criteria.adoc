...
To view the an example of the data structure, consult the https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File]. The information will be visible in the tab "EG-Convictions", and others.
...
The https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File] illustrates how the ONTRUE and ONFALSE SUBGROUPS of a Criterion of type "Contributions (exclusion grounds)" relate to each of its ''closer QUESTION'' of type INDICATOR. See the "element code" column.
...
The https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File], e.g., in criterion 36, demonstrates an example of the radio button class in use.
