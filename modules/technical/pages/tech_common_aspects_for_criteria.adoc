...
*Rule*: Each Criterion is defined in e-Certis and must use the UUID supplied by e-Certis. See also the spreadsheets https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[_ESPD-criterion_].
...
*Rule*: Compulsory use of codes coming from e-Certis, which are also used in the spreadsheets https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[_ESPD-criterion_], e.g. crime-org, corruption, chain-manage
...
*Rule*: The name should match the one from e-Certis, which should be the same as in the in the spreadsheets https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[_ESPD-criterion_], e.g. 'Convictions', 'Corruption', 'Fraud', 'Financial ratio', 'Subcontracting proportion'etc.).
...
https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Request.xml#L97

https://github.com/OP-TED/ESPD-EDM/blob/v4.1.0/xml-examples/ESPD-Response.xml#L111
...
See also the spreadsheet https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[_ESPD-criterion_].
...
To view the an example of the data structure, consult the https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File]. The information will be visible in the tab "EG-Convictions", and others.
...
The https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File] illustrates how the ONTRUE and ONFALSE SUBGROUPS of a Criterion of type "Contributions (exclusion grounds)" relate to each of its ''closer QUESTION'' of type INDICATOR. See the "element code" column.
...
_Figure 8. Case 1: When the first QUESTION ''Your Answer?'' is set to false_

image:Case2_first QUESTION_set_true.jpg[Case 2: When the first QUESTION ''Your Answer?'' is set to true,width=514,height=280]

_Figure 9. Case 2: When the first QUESTION ''Your Answer?'' is set to true_
...
_Figure 10. Case 3: When the first QUESTION ''Your Answer?'' and the option "Has this breach of obligations been established ..." are both set to true_

image:Case4_GUI_Control.jpg[Case 4: When all the QUESTION(s) that are INDICATORS are set to true,width=513,height=324]

_Figure 11. Case 4: When all the QUESTION(s) that are INDICATORS are set to true_

== Radio-Button and Check-box controls

The https://raw.github.com/OP-TED/ESPD-EDM/v4.1.0/criterion/ESPD-criterion.xlsx[Criterion File], e.g., in criterion 36, demonstrates an example of the radio button class in use.
...
<cac:TenderingCriterionProperty>
    <cbc:ID schemeID="criterion" schemeAgencyID="XXESPD-SERVICEXXX" schemeVersionID="4.1.0">C1_EG_crime-org/QG1/QSG1/Q1</cbc:ID>
    ...
</cac:TenderingCriterionProperty>
----
...
<cac:TenderingCriterionResponse> 
    <cbc:ID schemeID = "criterion" schemeAgencyID = "XXESPD-SERVICEXXX" schemeVersionID = "4.1.0">C1_EG_crime-org/QG1/QSG1/Q1/R2</cbc:ID> 
    <cbc:ValidatedCriterionPropertyID schemeID = "criterion" schemeAgencyID = "XXESPD-SERVICEXXX" schemeVersionID = "4.1.0">C1_EG_crime-org/QG1/QSG1/Q1</cbc:ValidatedCriterionPropertyID> 
    <cac:ResponseValue> 
            <cbc:ID schemeID = "criterion" schemeAgencyID = "XXESPD-SERVICEXXX" schemeVersionID = "4.1.0">C1_EG_crime-org/QG1/QSG1/Q1/R2/RV</cbc:ID> 
...
----
<cac:TenderingCriterionResponse> 
    <cbc:ID schemeID = "criterion" schemeAgencyID = "XXESPD-SERVICEXXX" schemeVersionID = "4.1.0">C1_EG_crime-org/QG2/QSG1/Q1/R1</cbc:ID>  
    <cbc:ValidatedCriterionPropertyID schemeID = "criterion" schemeAgencyID = "XXESPD-SERVICEXXX" schemeVersionID = "4.1.0">C1_EG_crime-org/QG2/QSG1/Q1</cbc:ValidatedCriterionPropertyID>  
