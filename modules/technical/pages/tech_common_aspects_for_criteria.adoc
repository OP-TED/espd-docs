...
[cols="<1,<4"]
|===
|*REQUIREMENT* xref:bs41.adoc#br[br41-002] |The contracting body shall provide the exclusion grounds and selection criteria for its tendering process as structured information - via ESPD template or structured list of criteria set out in a call for tender.
|===
...
xref:tbr70_reqs##list_of_criteria[tbr070-009]
...
*Information Requirement*: xref:tbr70_reqs#list_of_criteria[tbr070-010].
...
*Information Requirement*: xref:tbr70_reqs##list_of_criteria[tbr070-03][_tbr070-013_]
...
*Information Requirement*: xref:tbr70_reqs#list_of_criteria[tbr070-13]
...
xref:tbr70_reqs#list_of_criteria[tbr070-13]
