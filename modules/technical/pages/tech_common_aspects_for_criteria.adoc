...
xref:tech_br_request_reqs.adoc#list_of_criteria[tbr70-009]
...
*Information Requirement*: xref:tech_br_request_reqs.adoc#list_of_criteria[tbr70-010] .
...
*Information Requirement*: xref:tech_br_request_reqs.adoc#list_of_criteria[tbr70-013] 
...
xref:tech_br_request_reqs.adoc#list_of_criteria[tbr70-013] 
...
In version 2.1.0 a new code list named link:{url-tree}/codelists/gc/BooleanGUIControlType.gc[BooleanGUIControlType] was added to help software application process REQUIREMENT(s) issued by the buyer when drafting ESPD documents.
...
For this, imagine that each element of the Criteria Taxonomy data structures could contain (or be preceded by) one or more instructions addressed to the software application for one particular purpose. 
