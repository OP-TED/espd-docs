...
As suggested in section "Criteria Data Structures" criteria may be grouped in several different categories. The Criterion Filefigure is arranged in a tree-like structure with branches and leaves (end nodes), intended to identify and list these categories for the Exclusion criteria (branches), and specific subgroups within each category (leaves).
...
//image:Exclusion_criteria_classification.jpg[Exclusion criteria classification,width=510,height=374]
                ...
                <cac:SubTenderingCriterion>
                        ...
                        <cac:TenderingCriterionPropertyGroup>
                                ...
                                <cac:TenderingCriterionProperty>
                                        ...
                                        <cbc:Description>[Additional information; e.g. no evidence online]</cbc:Description>
...
//_Figure 5. 'Contributions' criterion data structure_
