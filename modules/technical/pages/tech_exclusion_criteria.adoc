...
See Criterion 1 (C1) in the https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/codelists/ESPD-criterion.xlsx[Criterion File].

=== XML Example

The xml of the criterion is best viewed directly in the xml examples made available in release v3.3 on GitHub:

https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/xml-examples/ESPD-Request.xml#L67

https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/xml-examples/ESPD-Response.xml#L106
...
See Criterion 7 (C7) in the https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/codelists/ESPD-criterion.xlsx[Criterion File].
...
https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/xml-examples/ESPD-Request.xml#L1145

https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/xml-examples/ESPD-Response.xml#L1184
...
See Criterion 9 (C9) in the https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/codelists/ESPD-criterion.xlsx[Criterion File].
...
https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/xml-examples/ESPD-Request.xml#L1719

https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/xml-examples/ESPD-Response.xml#L1758
...
See Criterion 12 (C12) in the https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/codelists/ESPD-criterion.xlsx[Criterion File].

=== XML Example

The xml of the criterion is best viewed directly in the xml examples made available in release v3.3 on GitHub:

https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/xml-examples/ESPD-Request.xml#L2115

https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/xml-examples/ESPD-Response.xml#L2154
...
See Criterion 18 (C18) in the https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/codelists/ESPD-criterion.xlsx[Criterion File].

=== XML Example

The xml of the criterion is best viewed directly in the xml examples made available in release v3.3 on GitHub:

https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/xml-examples/ESPD-Request.xml#L2875

https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/xml-examples/ESPD-Response.xml#L2914
...
See Criterion 20 (C20) in the https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/codelists/ESPD-criterion.xlsx[Criterion File].

=== XML Example

The xml of the criterion is best viewed directly in the xml examples made available in release v3.3 on GitHub:

https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/xml-examples/ESPD-Request.xml#L3169

https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/xml-examples/ESPD-Response.xml#L3209
...
See Criterion 22 (C22) in the https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/codelists/ESPD-criterion.xlsx[Criterion File].

=== XML Example

The xml of the criterion is best viewed directly in the xml examples made available in release v3.3 on GitHub:

https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/xml-examples/ESPD-Request.xml#L3401

https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/xml-examples/ESPD-Response.xml#L3440
...
See Criterion 23 (C23) in the https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/codelists/ESPD-criterion.xlsx[Criterion File]. 

=== XML Example

The xml of the criterion is best viewed directly in the xml examples made available in release v3.3 on GitHub:

https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/xml-examples/ESPD-Request.xml#L3549

https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/xml-examples/ESPD-Response.xml#L3588
...
See Criterion 24 (C24) in the https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/codelists/ESPD-criterion.xlsx[Criterion File].

=== XML Example

The xml of the criterion is best viewed directly in the xml examples made available in release v3.3 on GitHub:

https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/xml-examples/ESPD-Request.xml#L3648

https://github.com/OP-TED/ESPD-EDM/blob/v3.3.0/xml-examples/ESPD-Response.xml#L3687
