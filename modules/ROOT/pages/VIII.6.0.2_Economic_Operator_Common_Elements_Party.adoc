...
*Rule*: Only the 'Description' is expected, but the component cac:ClassificationScheme offers other rich possibilities (see the link:{attachmentsdir}/mod/UBL-Entities-2.2-Pre-award.ods[UBL-2.2 model in the distribution package] or in the https://www.oasis-open.org/committees/document.php?document_id=60554[original source] for more details).
...
*Rule*: Use it to place here the general Turnover of the EO (for statistical purposes). Compulsory assignment of a value to the attribute currency. The default value should be set to 'EUR'. Compulsory use of the Code List link:{attachmentsdir}/cl/ods/ESPD-CodeLists-V2.1.0.ods[CurrencyCode].
...
The code list link:{distUrlBlob202}/dist/cl/xlsx/ESPD-CodeLists-V2.0.2.xlsx[EOIDType]
...
*Rule*: Compulsory use of the Code List link:{attachmentsdir}/cl/ods/ESPD-CodeLists-V2.1.0.ods[EORoleType].
...
*Rule*: Software applications should retrieve and reuse the description from the Code List link:{attachmentsdir}/cl/ods/ESPD-CodeLists-V2.1.0.ods[EORoleType].
...
*Rule*: The country of the contracting body must always be specified. Compulsory use of the Code List link:{attachmentsdir}/cl/ods/ESPD-CodeLists-V2.1.0.ods[CountryCodeIdentifier] (ISO 3166-1 2A:2006).
...
*Rule*:  The country of the service provider must always be specified. Compulsory use of the Code List link:{attachmentsdir}/cl/ods/ESPD-CodeLists-V2.1.0.ods[CountryCodeIdentifier] (ISO 3166-1 2A:2006).
