...
The following features *are implemented* in the second set of transformation XSL-T style-sheet (From-REQUEST-to-RESPONSE.xslt files):
...
* The Criteria from the ESPD Request *are not* copied in the ESPD Response document. But the XML examples in the link:{url-tree-tmp}/dist/xml-examples/[xml-examples folder].
