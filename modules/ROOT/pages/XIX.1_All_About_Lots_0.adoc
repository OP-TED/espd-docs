...
link:{attachmentsdir}/dist/cl/xlsx/ESPD-CriteriaTaxonomy-Extended-V2.1.1.xlsx[Criteria Taxonomy spread-sheets]
...
link:{attachmentsdir}/dist/xml/Lots-Extended-Response_V2.1.1.xml[Lots-Extended-Response_V2.1.1.xml]_*
====
