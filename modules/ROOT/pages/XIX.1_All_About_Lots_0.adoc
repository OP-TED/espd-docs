...
link:{url-blob}/dist/cl/xlsx/ESPD-CriteriaTaxonomy-Extended-V2.1.1.xlsx[Criteria Taxonomy spread-sheets]
...
link:{url-blob}/dist/xml/Lots-Extended-Response_V2.1.1.xml[Lots-Extended-Response_V2.1.1.xml]_*
====
