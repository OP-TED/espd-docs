...
* *ESPD-Codelists.xlsx*: Code list source definition that is transformed using the /XLSX CodeLists to Genericode/Excel_to_GC_Multilang_v1.0.xsl into the .gc code list files in ESPD-EDM/codelists/gc. (A list of all the ESPD code lists).
