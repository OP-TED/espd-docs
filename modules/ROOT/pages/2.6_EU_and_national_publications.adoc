...
<cbc:DocumentTypeCode listID="docrefcontent-type" listAgencyID="OP" listVersionID="3.2.0">TED_CN</cbc:DocumentTypeCode>
...
<cbc:DocumentTypeCode listID="docrefcontent-type" listAgencyID="OP" listVersionID="3.2.0">NOJCN</cbc:DocumentTypeCode>
...
. The jurisdiction scope of this document is typified in the Code List docref-content-type (see file link:{url-tree-301}/codelists/gc/DocRefContentType.gc[/codelists/gc/DocRefContentType.gc] in the distribution package). *Beware that the name and content of this Code List has changed from the previous ESPD-EDM version 2.1.1*.
...
. In this case the code NOJCN means 'Contract Notice (CN) published on a National Government Official Journal' (see file link:{url-tree-301}/codelists/gc/DocRefContentType.gc[/codelists/gc/DocRefContentType.gc] in the distribution package).
