...
. In this case the code NOJCN means 'Contract Notice (CN) published on a National Government Official Journal' (see file docref-content-type.gc in the distribution package).
