...
link:{url-blob}/dist/cl/xlsx/ESPD-CriteriaTaxonomy-EXTENDED-V2.1.1.xlsx[ESPD-CriteriaTaxonomy] spread-sheet).

In this data structure the first REQUIREMENT set by the contracting authority is whether the criterion is to be WEIGHTED or not (the opposito to WEIGHTED is PASS/FAIL, see the Code List link:{url-blob}/dist/cl/xlsx/ESPD-CriteriaTaxonomy-EXTENDED-V2.1.1.xlsx[EvaluationMethodType]).
...
. The data structure (see the EXTENDED spread-sheet tab link:{url-blob}/dist/cl/ods/ESPD-CriteriaTaxonomy-EXTENDED-V2.1.1.ods[SC-Abilities_1]).
