...
Thus the folder link:{distUrl}/dist/xslt/ODS%20Data%20Structures%20to%20ESPD%20XML[dist/xslt/ODS Data Structures to ESPD XML] contains four XSL style-sheets that facilitate the generation of the complete set of criteria required in an ESDP Request or in an ESDP Response XML file.
