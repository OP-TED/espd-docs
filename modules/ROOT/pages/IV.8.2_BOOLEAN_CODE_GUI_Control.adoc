...
In version 2.1.0 a new code list named link:{url-blob}/dist/cl/xlsx/ESPD-CodeLists-V2.1.0.xlsx[BooleanGUIControlType]
...
.Use of the code list link:{url-blob}/dist/cl/xlsx/ESPD-CodeLists-V2.1.0.xlsx[BooleanGUIControlType]
...
link:{url-blob}/dist/cl/xlsx/ESPD-CriteriaTaxonomy-SELFCONTAINED-V2.1.0.xlsx[ESPD-SELF-CONTAINED Criteria Taxonomy] spread-sheet).
