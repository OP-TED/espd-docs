...
In version 2.1.0 a new code list named link:{url-blob}/dist/cl/xlsx/ESPD-CodeLists-V2.1.1.xlsx[BooleanGUIControlType]
...
.Use of the code list link:{url-blob}/dist/cl/xlsx/ESPD-CodeLists-V2.1.1.xlsx[BooleanGUIControlType]
...
link:{url-blob}/dist/cl/xlsx/ESPD-CodeLists-V2.1.1.xlsx[ResponseDataType]
...
link:{url-blob}/dist/cl/ods/ESPD-CriteriaTaxonomy-EXTENDED-V2.1.1.ods[ESPD-CriteriaTaxonomy-EXTENDED] spread-sheet).
