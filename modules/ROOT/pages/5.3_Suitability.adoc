...
(The figure below is defined in the the tab "Suitability-I of the link:{attachmentsdir}/dist/cl/xlsx/[ESPD Criterion Data Structure] spread-sheet).
...
(The figure below is defined in the the tab "Suitability-II" of the link:{attachmentsdir}/dist/cl/xlsx/[ESPD-criterion-V3.0.0] spread-sheet).
