...
(The figure below is defined in the the tab "Suitability-I of the link:{url-tree-301}/codelists/ESPD-criterion.xlsx[ESPD-criterion] spread-sheet).
...
(The figure below is defined in the the tab "Suitability-II" of the link:{url-tree-301}/codelists/ESPD-criterion.xlsx[ESPD-criterion] spread-sheet).
