...
*Rule*: The country of the contracting body must always be specified. Compulsory use of the Code List link:{url-tree}/codelists/gc/Country.gc[Country from EU Vocabularies, which is based on ISO.]  
...
*Rule*: The country of the service provider must always be specified. Compulsory use of the Code List link:{url-tree}/codelists/gc/Country.gc[Country from EU Vocabularies, which is based in ISO].
