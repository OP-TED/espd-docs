...
<7> In this case the code `NOJCN` means 'Contract Notice (CN) published on a National Government Official Journal' (see file link:{attachmentsdir}/dist/cl/ods/ESPD-CodeLists-V2.1.1.ods[ESPD-CodeLists-V2.1.1]) in the distribution package.