...
<7> In this case the code `NOJCN` means 'Contract Notice (CN) published on a National Government Official Journal' (see file link:{url-blob}/dist/cl/CodeLists-V2.0.1[CodeLists-V2.0.1]) in the distribution package.