...
<7> In this case the code `NOJCN` means 'Contract Notice (CN) published on a National Government Official Journal' (see file link:{attachmentsdir}/cl/CodeLists-V2.1.0[CodeLists-V2.1.0]) in the distribution package.