...
<7> In this case the code `NOJCN` means 'Contract Notice (CN) published on a National Government Official Journal' (see file link:{attachmentsdir}/cl/CodeLists-V2.0.2[CodeLists-V2.0.2]) in the distribution package.