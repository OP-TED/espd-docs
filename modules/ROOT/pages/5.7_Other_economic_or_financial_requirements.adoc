...
<!-- Criterion:Other economic or financial requirements -->
        <cac:TenderingCriterion>
                ...
                <cbc:CriterionTypeCode listID="criterion" listAgencyID="OP" listVersionID="20210616-0">finan-requ</cbc:CriterionTypeCode>
                ...
                <cac:TenderingCriterionPropertyGroup>
                        ...
                        <cac:SubsidiaryTenderingCriterionPropertyGroup>
                                ...
                                <cac:TenderingCriterionProperty>
                                        ...
                                        <cbc:ValueDataTypeCode listID="ResponseDataType" listAgencyID="EU-COM-GROW" listVersionID="3.0.1">CODE_BOOLEAN</cbc:ValueDataTypeCode>
                                ...
                                <cac:SubsidiaryTenderingCriterionPropertyGroup>
                                        ...
                                        <cac:TenderingCriterionProperty>
                                                ...
                                                <cbc:TypeCode listID="CriterionElementType" listAgencyID="EU-COM-GROW" listVersionID="3.0.1">REQUIREMENT</cbc:TypeCode>
                                                <cbc:ValueDataTypeCode listID="ResponseDataType" listAgencyID="EU-COM-GROW" listVersionID="3.0.1">QUANTITY</cbc:ValueDataTypeCode>
                                                <!-- No answer is expected here from the economic operator, as this is a REQUIREMENT issued by the buyer. Hence the element 'cbc:ValueDataTypeCode' contains the type of value of the requirement issued by the buyer -->
