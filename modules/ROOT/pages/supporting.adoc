...
The ESPD is supported by the eProcurement Ontology, and associated with two further projects:
...
[.banner]
We are currently investigating how our eSenders and data reusers use the Reuse (Bulk Downloads) Documentation . Please reply to our https://ec.europa.eu/eusurvey/runner/670dc92b-c6ef-94d5-3af0-c54d65b0ad6d[survey on Reusing TED XML Data from the TED Website] to help us improve our documentation according to your needs.
