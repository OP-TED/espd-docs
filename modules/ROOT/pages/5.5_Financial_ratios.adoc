...
<!-- Criterion:Financial ratio -->
        <cac:TenderingCriterion>
                <cbc:ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.4.0">e4d37adc-08cd-4f4d-a8d8-32b62b0a1f46</cbc:ID>
                ...
                <cac:Legislation>
                        <cbc:ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.4.0">387118be-f732-49f2-982a-5bdb4d9e52ff</cbc:ID>
                ...
                <cac:TenderingCriterionPropertyGroup>
                        <cbc:ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.4.0">cc1da737-6c4e-4f4e-821d-c260029058f6</cbc:ID>
                        ...
                        <cac:TenderingCriterionProperty>
                                <cbc:ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.4.0">889620da-979a-4ce9-b4a7-aaa8aef09066</cbc:ID>
                        ...
                        <cac:SubsidiaryTenderingCriterionPropertyGroup>
                                <cbc:ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.4.0">ee486082-93fa-4c17-8920-fdf01b890bd1</cbc:ID>
                                <cbc:PropertyGroupTypeCode listID="property-group-type" listAgencyID="OP" listVersionID="4.4.0">ON*</cbc:PropertyGroupTypeCode>
                                <cac:TenderingCriterionProperty>
                                        <cbc:ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.4.0">96df5f9f-f458-40cf-818f-a2beade58b1a</cbc:ID>
                                        ...
                                        <!-- No answer is expected here from the economic operator, as this is a REQUIREMENT issued by the buyer. Hence the element 'cbc:ValueDataTypeCode' contains the type of value of the requirement issued by the buyer -->
                                        <cbc:ExpectedCode listID="financial-ratio-type" listAgencyID="OP" listVersionID="4.4.0">Assets to equity ratio</cbc:ExpectedCode>
                                </cac:TenderingCriterionProperty>
                                <cac:TenderingCriterionProperty>
                                        <cbc:ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.4.0">1649c3aa-db0b-40cc-adb0-561f13531cf5</cbc:ID>
                                ...
                                <cac:TenderingCriterionProperty>
                                        <cbc:ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.4.0">b5d47ff0-f82b-4818-9e2e-88d2c133544d</cbc:ID>
                        ...
                        <cac:SubsidiaryTenderingCriterionPropertyGroup>
                                ...
                                <cbc:PropertyGroupTypeCode listID="property-group-type" listAgencyID="OP" listVersionID="4.4.0">ON*</cbc:PropertyGroupTypeCode>
                                <cac:TenderingCriterionProperty>
                                        <cbc:ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.4.0">6234d4cc-1936-4e1c-9d87-0bcd7f01cd7c</cbc:ID>
                                ...
                                <cac:SubsidiaryTenderingCriterionPropertyGroup>
                                        ...
                                        <cac:TenderingCriterionProperty>
                                                <cbc:ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.4.0">f1aec98d-5991-4119-9ffd-a95486a7ce68</cbc:ID>
                                ...
                                <cac:SubsidiaryTenderingCriterionPropertyGroup>
                                        ...
                                        <cac:TenderingCriterionProperty>
                                                <cbc:ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.4.0">99a61ff5-addf-41b3-9e89-55b576e1b35d</cbc:ID>
                                                <cbc:Description>Name of the entity</cbc:Description>
                                                <cbc:TypeCode listID="criterion-element-type" listAgencyID="OP" listVersionID="4.4.0">QUESTION</cbc:TypeCode>
                                                <cbc:ValueDataTypeCode listID="response-data-type" listAgencyID="OP" listVersionID="4.4.0">DESCRIPTION</cbc:ValueDataTypeCode>
                                        </cac:TenderingCriterionProperty>
                                        <cac:TenderingCriterionProperty>
                                                <cbc:ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.4.0">104cc794-cb50-4387-bbad-b64c0d5d3c26</cbc:ID>
                        ...
                        <cac:SubsidiaryTenderingCriterionPropertyGroup>
                                ...
                                <cbc:PropertyGroupTypeCode listID="property-group-type" listAgencyID="OP" listVersionID="4.4.0">ON*</cbc:PropertyGroupTypeCode>
                                <cac:TenderingCriterionProperty>
                                        <cbc:ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.4.0">a8c29eb0-9a60-4e7f-9685-41195e02fc99</cbc:ID>
                        ...
                        <cac:SubsidiaryTenderingCriterionPropertyGroup>
                                ...
                                <cbc:PropertyGroupTypeCode listID="property-group-type" listAgencyID="OP" listVersionID="4.4.0">ON*</cbc:PropertyGroupTypeCode>
                                <cac:TenderingCriterionProperty>
                                        <cbc:ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.4.0">8d06c2c6-8353-499a-8390-e676771008c0</cbc:ID>
                                ...
                                <cac:SubsidiaryTenderingCriterionPropertyGroup>
                                        ...
                                        <cbc:PropertyGroupTypeCode listID="property-group-type" listAgencyID="OP" listVersionID="4.4.0">ONTRUE</cbc:PropertyGroupTypeCode>
                                        <cac:TenderingCriterionProperty>
                                                <cbc:ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.4.0">77cbefd5-6683-41da-8c25-19bfbf2b5f4b</cbc:ID>
