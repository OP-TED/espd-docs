...
To see how to xref:espd_form.adoc[fill in a form on an online ESPD-Service from the perspectives of both a buyer and suppliers], click on the linked text. This will demonstrate the use of an ESPD-Service from scratch (first time).
