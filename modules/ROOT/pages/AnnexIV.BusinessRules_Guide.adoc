...
.Table 85: Tendering Criterion - Regulated structure
...
.Table 91: Tendering Criterion - Self-contained structure
...
* Severity: ERROR
* Compulsory use of the code list identified within the �ǣ18 Annex I: XSDs elements and Code Lists
...
* Severity: ERROR
* Compulsory use of the elements listed within �ǣ19 Annex II: Compulsory XSDs elements
