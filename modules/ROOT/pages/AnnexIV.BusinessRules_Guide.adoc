...
|XML Implementation Guide (current document) link:https://docs.ted.europa.eu/ESPD-EDM/latest/index.html[Technical HandBook] |3.2.0 |Understanding of the model underlying the implementation of the ESPD Request and ESPD Response XML documents.
a|
|===
...
|*Qualifying party* is *compulsory* in the ESPD-EDM V3.2.0 as it is the natural placeholder for several relevant data about the Economic Operator. | a|
* {blank}
+
____
Severity: ERROR
...
|This element is compulsory in the ESPD-EDM V3.2.0 because depending on it different sets of data will be required or not, shown or hidden, processed or skipped. | a|
* {blank}
+
____
Severity: ERROR
