...
<!-- Criterion:For supply contracts: performance of deliveries of the specified type -->
        <cac:TenderingCriterion>
                ...
                <cbc:CriterionTypeCode listID="criterion" listAgencyID="OP" listVersionID="20210616-0">supply-perform</cbc:CriterionTypeCode>
                ...
                <cac:TenderingCriterionPropertyGroup>
                        ...
                        <cac:TenderingCriterionProperty>
                                ...
                                <cbc:ValueDataTypeCode listID="ResponseDataType" listAgencyID="EU-COM-GROW" listVersionID="3.0.1">QUANTITY_INTEGER</cbc:ValueDataTypeCode>
