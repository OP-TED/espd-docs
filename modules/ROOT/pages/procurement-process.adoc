...
[arabic]
. *Pre-tendering* — preparation and planning of the procedure
. *Tendering* — publication, submission, qualification, evaluation, and award
. *Post-tendering* — contract implementation
