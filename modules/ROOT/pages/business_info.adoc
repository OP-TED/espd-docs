...
The ESPD Service tool enables Buyers and Suppliers to create, edit, export and import electronic documents in XML format (eESPD) for the exchange of criteria, requirements, statements and references regarding eligibility to participate in public procurement.
...
[.text-left]
The main objective of the ESPD is to reduce administrative burden by removing the need to produce large numbers of physical certificates and documentation related to exclusion and selection criteria. The intention was to make participation less burdensome for  small and medium-sized enterprises (SMEs).
