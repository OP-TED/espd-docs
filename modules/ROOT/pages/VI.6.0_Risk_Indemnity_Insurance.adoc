...
[cols="<1, <4"]
|===
|*REQUIREMENT*| Compulsory use of the code list link:{url-blob}/dist/cl/ods/ESPD-CodeLists-V2.1.1.ods[`InsuranceType`] for the Extended ESPD of the ESPD.
|=== 
...
. In the *Extended* ESPD the contracting authority can require one minimum amount for multiple insurances, each one of a different type (see the code list link:{url-blob}/dist/cl/ods/ESPD-CodeLists-V2.1.1.ods[`InsuranceType`]);
