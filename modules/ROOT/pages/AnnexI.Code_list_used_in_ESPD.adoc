...
|CriteriaType |DG GROW (European Commission, defined in e-Certis) |See each Criterion taxonomy code in the link:{url-tree-301}/__ESPDTeam__/ESPD-CodeLists.xlsx[Criteria Data] Structures. See also the link:{url-tree-301}/codelists/ESPD-criterion.xlsx[+++Genericode file+++].
...
|FinancialRatioType |BACH Banque de France |Used in the REQUIREMENT "Ratio Type" of the Criterion  *finan-rat*. See data structure for this criterion in the ESPD Request link:{url-tree-301}/codelists/ESPD-criterion.xlsx[ESPD-criterion].
