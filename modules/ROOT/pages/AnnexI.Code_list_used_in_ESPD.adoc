...
|CriteriaType |DG GROW (European Commission, defined in e-Certis) |See each Criterion taxonomy code in the link:{url-tree}/\\__ESPDTeam\\__/ESPD-CodeLists.xlsx[Criteria Data] Structures. See also the link:{url-tree}/codelists/ESPD-criterion.xlsx[+++Genericode file+++].
