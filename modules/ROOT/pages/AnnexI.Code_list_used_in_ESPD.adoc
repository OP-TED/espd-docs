...
|CriteriaType |DG GROW (European Commission, defined in e-Certis) |See each Criterion taxonomy code in the link:{url-tree-tmp}/__ESPDTeam__/ESPD-CodeLists.xlsx[Criteria Data] Structures. See also the link:{url-tree-tmp}/codelists/ESPD-criterion.xlsx[+++Genericode file+++].
