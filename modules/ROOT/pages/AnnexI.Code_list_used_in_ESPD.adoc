...
|FinancialRatioType |BACH Banque de France |Used in the REQUIREMENT "Ratio Type" of the Criterion  *finan-rat*. See data structure for this criterion in the ESPD Request link:{url-tree-tmp}/codelists/ESPD-criterion.xlsx[ESPD-criterion].
