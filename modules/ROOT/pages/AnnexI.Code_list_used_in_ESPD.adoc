...
|CriteriaType |DG GROW (European Commission, defined in e-Certis) |See each Criterion taxonomy code in the link:{attachmentsdir}/dist/cl/ods/ESPD-CodeLists-V3.0.0.ods[Criteria Data] Structures. See also the link:{url-blob-211}/dist/cl/gc/ESPD-CriteriaTaxonomy_V2.1.1.gc[+++Genericode file+++].
