...
* The link:{url-tree-tmp}/dist/cl/ods/ESPD-CodeLists-V3.0.0.ods[spread-sheet] distributed with this documentation;


* The multilingual link:{url-tree-tmp}/dist/cl/gc[Genericode] *.gc files automatically produced based on these spread-sheets; and
...
|CriteriaType |DG GROW (European Commission, defined in e-Certis) |See each Criterion taxonomy code in the link:{url-tree-tmp}/dist/cl/ods/ESPD-CodeLists-V3.0.0.ods[Criteria Data] Structures. See also the link:{url-tree-tmp-211}/dist/cl/gc/ESPD-CriteriaTaxonomy_V2.1.1.gc[+++Genericode file+++].
...
|docref-content-type |DG GROW (European Commission) |UBL-2.3 element cac:AdditionalDocumentReference/{zwsp}cbc:DocumentTypeCode. See XML example in section *2.5 EU and national publications*
...
|FinancialRatioType |BACH Banque de France |Used in the REQUIREMENT "Ratio Type" of the Criterion  *finan-rat*. See data structure for this criterion in the ESPD Request link:{url-tree-tmp}/dist/cl/ods/ESPD-CodeLists-V3.0.0.ods[+++spread-sheet+++].
