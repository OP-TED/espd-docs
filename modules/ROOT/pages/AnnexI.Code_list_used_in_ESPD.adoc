...
* The link:{url-blob}/dist/cl/ods/ESPD-CodeLists-V3.0.0.ods[spread-sheet] distributed with this documentation;
...
|CriteriaType |DG GROW (European Commission, defined in e-Certis) |See each Criterion taxonomy code in the link:{url-blob}/dist/cl/ods/ESPD-CodeLists-V3.0.0.ods[Criteria Data] Structures. See also the link:{url-blob-211}/dist/cl/gc/ESPD-CriteriaTaxonomy_V2.1.1.gc[+++Genericode file+++].
...
|FinancialRatioType |BACH Banque de France |Used in the REQUIREMENT "Ratio Type" of the Criterion  *finan-rat*. See data structure for this criterion in the ESPD Request link:{url-blob}/dist/cl/ods/ESPD-CodeLists-V3.0.0.ods[+++spread-sheet+++].
