...
*Rule*: Compulsory use of the UUIDs supplied by e-Certis. See also the spreadsheets link:dist/ods/ESPD-CriteriaTaxonomy-TrackChanges-REGULATED.ods [_Criteria Taxonomy (Regulated ESPD)_] and link:dist/ods/ESPD-CriteriaTaxonomy-TrackChanges-SELFCONTAINED.ods [_Criteria Taxonomy (Self-contained ESPD)_]. 
