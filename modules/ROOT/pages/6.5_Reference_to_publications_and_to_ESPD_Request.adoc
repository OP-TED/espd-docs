...
*Rule*: For the ESDP-EDM it is compulsory use of the value ESPD_REQUEST from the Code List link:{url-tree}/codelists/gc/docref-content-type.gc[_doc-ref-content-type_]. See also the XML example below on how to specify the ESPD Request.
