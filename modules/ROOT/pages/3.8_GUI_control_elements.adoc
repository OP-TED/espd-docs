...
Three codes concerning the GROUPS or SUBGROUPS of REQUIREMENT(s) and QUESTION(s) are defined in the code list link:{url-blob}/tree}codelists/gc/PropertyGroupType.gc[PropertyGroupType]:
