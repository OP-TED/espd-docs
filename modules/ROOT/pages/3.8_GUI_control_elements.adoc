...
<ID schemeAgencyID="OP" schemeVersionID="4.4.0">26ece6a2-b360-46c1-890d-8338913b8719</ID>

<PropertyGroupTypeCode listID="property-group-type" listAgencyID="OP" listVersionID="4.4.0">ON*</PropertyGroupTypeCode>

<cac:TenderingCriterionProperty>

<ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.4.0">9c62f2c7-0c51-451d-8730-427f92ed618c</ID>

<Description>Select the type of requirement</Description>

<TypeCode listID="criterion-element-type" listAgencyID="OP" listVersionID="4.4.0">REQUIREMENT</TypeCode>

<ValueDataTypeCode listID="response-data-type" listAgencyID="OP" listVersionID="4.4.0">CODE_BOOLEAN</ValueDataTypeCode>

<ExpectedCode listID="boolean-gui-control-type" listAgencyID="OP" listVersionID="4.4.0">RADIO_BUTTON_TRUE</ExpectedCode>
...
<PropertyGroupTypeCode listID="property-group-type" listAgencyID="OP" listVersionID="4.4.0">ONTRUE</PropertyGroupTypeCode>

<cac:TenderingCriterionProperty>

<ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.4.0">13728a54-21e3-4c84-8b11-48666c3d260f</ID>

<Description>Specify the total invoiced amount, taxes included.</Description>

<TypeCode listID="criterion-element-type" listAgencyID="OP" listVersionID="4.4.0">REQUIREMENT</TypeCode>

<ValueDataTypeCode listID="response-data-type" listAgencyID="OP" listVersionID="4.4.0">DESCRIPTION</ValueDataTypeCode>
...
<ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.4.0">48c7b3bf-8d1c-4497-a915-78d53ba68089</ID>

<Description>Minimum amount</Description>

<TypeCode listID="criterion-element-type" listAgencyID="OP" listVersionID="4.4.0">REQUIREMENT</TypeCode>

<ValueDataTypeCode listID="response-data-type" listAgencyID="OP" listVersionID="4.4.0">AMOUNT</ValueDataTypeCode>
...
<ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.4.0">8b4ae4f0-2849-49ea-a64b-7bb20c60bde4</ID>

<Description>Start date; End date</Description>

<TypeCode listID="criterion-element-type" listAgencyID="OP" listVersionID="4.4.0">REQUIREMENT</TypeCode>

<ValueDataTypeCode listID="response-data-type" listAgencyID="OP" listVersionID="4.4.0">PERIOD</ValueDataTypeCode>
...
<ID schemeAgencyID="OP" schemeVersionID="4.4.0">9b3a04ff-e36d-4d4f-b47c-82ad402b9b02</ID>

<PropertyGroupTypeCode listID="property-group-type" listAgencyID="OP" listVersionID="4.4.0"></PropertyGroupTypeCode>

<cac:TenderingCriterionProperty>

<ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.4.0">1d89c188-58d2-461e-a4f6-a17f689d87f4</ID>

<Description>Amount</Description>

<TypeCode listID="criterion-element-type" listAgencyID="OP" listVersionID="4.4.0">QUESTION</TypeCode>
...
<ID schemeAgencyID="OP" schemeVersionID="4.4.0">cc96aa19-a0be-4409-af58-ff3f3812741b</ID>

<PropertyGroupTypeCode listID="property-group-type" listAgencyID="OP" listVersionID="4.4.0">ONFALSE</PropertyGroupTypeCode>

<cac:TenderingCriterionProperty>

<ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.4.0">57d4160f-20b4-4b43-967b-76b038a2fa6b</ID>

<Description>Minimum rating</Description>

<TypeCode listID="criterion-element-type" listAgencyID="OP" listVersionID="4.4.0">REQUIREMENT</TypeCode>

<ValueDataTypeCode listID="response-data-type" listAgencyID="OP" listVersionID="4.4.0">QUANTITY</ValueDataTypeCode>

</cac:TenderingCriterionProperty>

<cac:TenderingCriterionProperty>

<ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.4.0">f07b5174-93ae-46dd-aa26-7f451d97f6a8</ID>
...
<ID schemeAgencyID="OP" schemeVersionID="4.4.0">5fe93344-ed91-4f97-bcab-b6720a131798</ID>

<PropertyGroupTypeCode listID="property-group-type" listAgencyID="OP" listVersionID="4.4.0"></PropertyGroupTypeCode>

<cac:TenderingCriterionProperty>

<ID schemeID="criterion" schemeAgencyID="OP" schemeVersionID="4.4.0">3bd1913b-c461-41eb-87c4-84e003785a56</ID>
...
<ID schemeID="ISO/IEC 9834-8:2008 - 4UUID" schemeAgencyID="OP" schemeVersionID="4.4.0">76085d25-05ad-4cb3-b1e0-675558e3f43e</ID>

<ValidatedCriterionPropertyID schemeID="CriteriaTaxonomy" schemeAgencyID="OP" schemeVersionID="4.4.0">1d89c188-58d2-461e-a4f6-a17f689d87f4</ValidatedCriterionPropertyID>

<cac:ResponseValue>

<ID schemeID="ISO/IEC 9834-8:2008 - 4UUID" schemeAgencyID="OP" schemeVersionID="4.4.0">42245674-d305-40bf-8b58-87ba51313345</ID>
