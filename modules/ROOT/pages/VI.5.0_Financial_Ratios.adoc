...
** To specify one of the codes defined by BACH to specify the type of the ratio (see https://www.bach.banque-france.fr/[BACH Banque France], and link:{attachmentsdir}/cl/ods/ESPD-CodeLists-V2.1.0.ods[FinancialRatioType]);
