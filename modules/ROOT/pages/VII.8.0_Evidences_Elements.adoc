...
*Rule*: Compulsory use of the Code List link:{url-blob}/dist/cl/ods/ESPD-CodeLists-V02.00.00.ods[ConfidentialityLevel]. Software application should set this code to CONFIDENTIAL automatically when the confidentiality level code of at least one criterion to which this evidence is associated is set to CONFIDENTIAL.
