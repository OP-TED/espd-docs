...
. *xslt*: transformation stylesheets used to generate basic sample XML instances from the criteria defined in spreadsheets link:{attachmentsdir}/cl/ods/ESPD-CriteriaTaxonomy-REGULATED-V2.0.2.ods[*REGULATED* ESPD data structures] and link:{attachmentsdir}/cl/ods/ESPD-CriteriaTaxonomy-SELFCONTAINED-V2.0.2.ods[*SELF-CONTAINED* ESPD data structures] (see folder link:{distUrl}/dist/cl[dist/cl]).
