...
. *xslt*: transformation stylesheets used to generate basic sample XML instances from the criteria defined in spreadsheets link:{url-blob}/dist/cl/ods/ESPD-Data_Structures-REGULATED-V02.00.00.ods[*REGULATED* ESPD data structures] and link:{url-blob}/dist/cl/ods/ESPD-Data_Structures-SELFCONTAINED-V02.00.00.ods[*SELF-CONTAINED* ESPD data structures] (see folder link:{url-tree}/dist/cl[dist/cl]).
