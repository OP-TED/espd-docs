...
. *xslt*: transformation stylesheets used to generate basic sample XML instances from the criteria defined in spreadsheets link:{attachmentsdir}/dist/cl/ods/ESPD-CriteriaTaxonomy-BASIC-V2.1.1.ods[*Basic* ESPD data structures] and link:{attachmentsdir}/dist/cl/ods/ESPD-CriteriaTaxonomy-EXTENDED-V2.1.1.ods[*Extended* ESPD data structures] (see folder link:{url-tree}/dist/cl[dist/cl]).
