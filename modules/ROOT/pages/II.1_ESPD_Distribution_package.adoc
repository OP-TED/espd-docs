...
. *xslt*: transformation stylesheets used to generate basic sample XML instances from the criteria defined in spreadsheets link:{url-blob}/dist/cl/ods/ESPD-CriteriaTaxonomy-REGULATED-V2.1.0.ods[*REGULATED* ESPD data structures] and link:{url-blob}/dist/cl/ods/ESPD-CriteriaTaxonomy-SELFCONTAINED-V2.1.0.ods[*SELF-CONTAINED* ESPD data structures] (see folder link:{url-tree}/dist/cl[dist/cl]).
