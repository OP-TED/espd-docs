...
<13> For the expected values in  the `cbc:ValueDataTypeCode` element please see the link:{attachmentsdir}/dist/cl/ods/ESPD-CodeLists-V2.0.1.ods[Code List 'ResponseDataType'].s
