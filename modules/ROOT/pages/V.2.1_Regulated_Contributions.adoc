...
<13> For the expected values in  the `cbc:ValueDataTypeCode` element please see the link:{url-blob}/dist/cl/ods/ESPD-CodeLists-V02.00.01.ods[Code List 'ResponseDataType'].s
