...
See formal requirements related to exclusion grounds criteria in the 
link:http://wiki.ds.unipi.gr/pages/viewpage.action?pageId=44367916[BIS 41 - European Single Procurement Document (Version 2.0.0)], and more specifically 
pass:macros[https://wiki.ds.unipi.gr/display/ESPDInt/BIS+41+-+ESPD+V2.1.0#:~:text=criteria%20regarding%20Suitability.-,tbr070%2D009,-The%20ESPD%20request[tbr070-009\]], 
pass:macros[https://wiki.ds.unipi.gr/display/ESPDInt/BIS+41+-+ESPD+V2.1.0#:~:text=to%20national%20legislation.-,tbr070%2D004,-The%20contracting%20body[tbr070-004\]]
,
