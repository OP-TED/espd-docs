...
====
[.text-left]
All ESPDResponse XML instances (and the ESPDRequest instances, too, for that matter) MUST always include all the exclusion criterion detailed in the http://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32016R0007[Annex of the Regulation 2016] 
