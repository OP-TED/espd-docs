...
The https://docs.ted.europa.eu/espd-demo/[ESPD Demo Site] is a collection of tools designed to help developers who are in the process of creating an ESPD Service. Click on the link above to access the site.

The info video below explains more about the tools available.
...
=== View
See criteria displayed in HTML

The ESPD Model Viewer demonstrates how a criterion in the model might be represented in HTML in an ESPD Service. Individual criteria can be filtered for per version, which are then displayed in HTML on the page. 
