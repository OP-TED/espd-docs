...
----
|*MANDATORY* (1..1) 
|`*Rule*: Compulsory use of the UUIDs from the table link:{attachmentsdir}/code_lists/xls/CriteriaTaxonomy.xlsx[Criteria]`
...
----
|*MANDATORY* (1..1)
|`*Comment*: The names of the criteria can be obtained from the table link:{attachmentsdir}/code_lists/xls/CriteriaTaxonomy.xlsx[Criteria]`
...
----
|*MANDATORY* (1..1) 
|`*Comment*: The descriptions of the criteria can be obtained from the table link:{attachmentsdir}/code_lists/xls/CriteriaTaxonomy.xlsx[Criteria]`
...
link:{attachmentsdir}/code_lists/xls/CriteriaTaxonomy.xlsx[EU Exclusion Criteria]`
