...
. The data structure (see the SELF-CONTAINED spread-sheet tab link:{url-blob}/dist/cl/ods/ESPDRequest-CriteriaTaxonomy-SELFCONTAINED-V02.00.00.ods[SC-Abilities_1]). 
