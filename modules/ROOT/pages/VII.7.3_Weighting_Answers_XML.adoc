...
. The data structure (see the SELF-CONTAINED spread-sheet tab link:{attachmentsdir}/dist/cl/ods/ESPDRequest-CriteriaTaxonomy-SELFCONTAINED-V2.0.1.ods[SC-Abilities_1]). 
