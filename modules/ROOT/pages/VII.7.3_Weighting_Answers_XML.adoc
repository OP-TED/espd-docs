...
. The data structure (see the SELF-CONTAINED spread-sheet tab link:{url-blob}/dist/cl/ods/ESPD-CriteriaTaxonomy-TrackChanges-SELFCONTAINED.ods[SC-Abilities_1]). 
