...
<13> Code to identify the type of the company (micro, small, medium, SME, Large). Notice the use of the Code List link:{url-blob}/dist/cl/ods/ESPD-CodeLists-V2.0.1.ods[EOIndustryClassificationCode] (for statistical purposes).
...
link:{url-blob}/dist/cl/ods/ESPD-CodeLists-V2.0.1.ods[EOIDType].
