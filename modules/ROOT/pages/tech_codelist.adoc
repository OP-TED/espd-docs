...
== currency
An example of how to use this code list can be found in xref:xref:tech_codelist_examples.adoc#currency-xml-example[currency xml Example].
...
== docrefcontent-type 
An example of how to use this code list can be found in xref:xref:tech_codelist_examples.adoc#docrefcontent-type-xml-example[docrefcontent-type xml Example].
