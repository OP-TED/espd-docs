...
*Rule*: Compulsory use of the Code List link:{attachmentsdir}/dist/cl/ods/ESPD-CodeLists-V3.0.0.ods[access-right]. Software application should set this code to CONFIDENTIAL automatically when the confidentiality level code of at least one criterion to which this evidence is associated is set to CONFIDENTIAL.
