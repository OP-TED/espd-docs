...
*Rule*: Compulsory use of the Code List link:{url-blob}/dist/cl/ods/ESPD-CodeLists-V3.0.0.ods[access-right]. Software application should set this code to CONFIDENTIAL automatically when the confidentiality level code of at least one criterion to which this evidence is associated is set to CONFIDENTIAL.
...
|*cac:IssuerParty/cac:Party/cac:PartyName/cbc:Name* |Text |0..1 |The name of the party issuer of the documentary evidence. a|
*Information Requirement*: link:http://wiki.ds.unipi.gr/display/ESPDInt/BIS+41+-+ESPD+V2.1.0#BIS41-ESPDV2.1-tbr092-017[_tbr092-017, tbr092-007, tbr092-006_]

*Rule*: ESPD-EDM uses this element to keep the name of the evidence issuer in the ESPD Response XML instance.

|*cac:IssuerParty/cac:Party/cac:PartyName/cbc:Name* |URI |0..1 |The website of the party issuer of the documentary evidence. a|
*Information Requirement*: link:http://wiki.ds.unipi.gr/display/ESPDInt/BIS+41+-+ESPD+V2.1.0#BIS41-ESPDV2.1-tbr092-017[_tbr092-017, tbr092-007, tbr092-006_]
