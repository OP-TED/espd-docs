...
The ESPD-EDM V3.0.0 uses always the one inside the document reference to refer to the issuer of the evidence (and of the document that 'is' the evidence). Thus the element used in the ESPD is cac:Evidence/cac:DocumentReference/cac:IssuerParty/cac:Party/cac:PartyIdentification/cbc:ID.
====
...
*Rule*: Compulsory use of the Code List link:{url-tree-tmp}/codelists/gc/access-right.gc[access-right]. Software application should set this code to CONFIDENTIAL automatically when the confidentiality level code of at least one criterion to which this evidence is associated is set to CONFIDENTIAL.
...
<cbc:ConfidentialityLevelCode listID="access-right" listAgencyID="OP" listVersionID="20211208-0">PUBLIC</cbc:ConfidentialityLevelCode> <2>
...
<cbc:ConfidentialityLevelCode listID="access-right" listAgencyID="OP" listVersionID="20211208-0">CONFIDENTIAL</cbc:ConfidentialityLevelCode> <5>
...
<cbc:ConfidentialityLevelCode listID="access-right" listAgencyID="OP" listVersionID="20211208-0">PUBLIC</cbc:ConfidentialityLevelCode> <8>
...
<cbc:ConfidentialityLevelCode listID="access-right" listAgencyID="OP" listVersionID="20211208-0">CONFIDENTIAL</cbc:ConfidentialityLevelCode> <13>
