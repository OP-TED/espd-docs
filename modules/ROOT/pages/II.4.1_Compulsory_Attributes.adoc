...
UBL-2.2 CCT are defined in the file `CCTS_CCT_SchemaModule-2.2.xsd` (see folders `xsd/common` or `xsdrt/common` in the link:{attachmentsdir}/espd-edm-v2.0.2.zip[distribution package]).
