...
.. link:{url-blob}/dist/cl/xlsx/ESPD-CriteriaTaxonomy-REGULATED-V2.1.0.xlsx[Criteria Taxonomy (Regulated ESPD)]
.. link:{url-blob}/dist/cl/xlsx/ESPD-CriteriaTaxonomy-SELFCONTAINED-V2.1.0.xlsx[Self-contained ESPD)]
