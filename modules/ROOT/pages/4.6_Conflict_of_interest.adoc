...
<!-- Criterion:Conflict of interest due to its participation in the procurement procedure -->
        <cac:TenderingCriterion>
                ...
                <cbc:CriterionTypeCode listID="criterion" listAgencyID="OP" listVersionID="20210616-0">partic-confl</cbc:CriterionTypeCode>
