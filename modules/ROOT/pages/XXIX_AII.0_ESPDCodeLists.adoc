...
|BidType|Publications Office of the EU|See link:{url-blob-211}/dist/cl/ods/ESPD-CriteriaTaxonomy-Extended-V2.1.1.ods[Data structure] and XML examples for Criterion `CRITERION.OTHER.CA_DATA.LOTS_SUBMISSION` of the *Extended ESPD Request*
...
|CriteriaType|DG GROW (European Commission, defined in e-Certis)|See each Criterion taxonomy code in the link:{url-blob}/dist/cl/ods[Criteria Taxonomies] (both Basic and Extended). See also the link:{url-blob-211}/dist/cl/gc/ESPD-CriteriaTaxonomy_V2.1.1.gc[Genericode file].
