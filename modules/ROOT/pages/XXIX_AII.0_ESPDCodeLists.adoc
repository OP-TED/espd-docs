...
* The link:{url-blob}/dist/cl/ods/[spread-sheet] distributed with this documentation;
...
|BidType|Publications Office of the EU|See link:{url-blob}/dist/cl/ods/ESPD-CriteriaTaxonomy-SELFCONTAINED-V2.1.0.ods[Data structure] and XML examples for Criterion `CRITERION.OTHER.CA_DATA.LOTS_SUBMISSION` of the *SELF-CONTAINED ESPD Request*
...
|CriteriaType|DG GROW (European Commission, defined in e-Certis)|See each Criterion taxonomy code in the link:{url-blob}/dist/cl/ods[Criteria Taxonomies] (both REGULATED and SELF-CONTAINED). See also the link:{url-blob}/dist/cl/gc/ESPD-CriteriaTaxonomy_V2.1.0.gc[Genericode file].
