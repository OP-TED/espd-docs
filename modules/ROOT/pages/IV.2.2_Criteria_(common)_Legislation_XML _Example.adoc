...
<4> Use the textual values (descriptions) listed in the Code List `LegislationType` link:{url-blob}/dist/cl/ods/ESPD-CodeLists-V2.1.0.ods[ESPD-CodeLists-V2.1.0.ods]
