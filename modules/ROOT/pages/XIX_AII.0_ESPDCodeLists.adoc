...
* The link:{distUrl}/dist/cl/ods/[spread-sheet] distributed with this documentation;
...
|BidType|Publications Office of the EU|See link:{attachmentsdir}/dist/cl/ods/ESPD-CriteriaTaxonomy-SELFCONTAINED-V2.0.2.ods[Data structure] and XML examples for Criterion `CRITERION.OTHER.CA_DATA.LOTS_SUBMISSION` of the *SELF-CONTAINED ESPD Request*
...
|CriteriaType|DG GROW (European Commission, defined in e-Certis)|See each Criterion taxonomy code in the link:{distUrl}/dist/cl/ods[Criteria Taxonomies] (both REGULATED and SELF-CONTAINED). See also the link:{attachmentsdir}/dist/cl/gc/ESPD-CriteriaTaxonomy_V2.0.2.gc[Genericode file].
