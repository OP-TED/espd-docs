...
the link:{attachmentsdir}/dist/cl/ods/ESPD-CriteriaTaxonomy-REGULATED-V2.0.2.ods[REGULATED] and the
link:{attachmentsdir}/dist/cl/ods/ESPD-CriteriaTaxonomy-SELFCONTAINED-V2.0.2.ods[SELF-CONTAINED] flavours.
...
See also details in: link:++{attachmentsdir}/dist/rn/Release Notes-2.0.2.ods++[Release Notes Details] and in this Github "Issues" section.
