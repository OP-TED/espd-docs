...
*** _Component_: replaced by _cac:TenderingCriterion/cac:ProcurementProjectLotReference_.
...
*** _Component_: replaced by _cac:ProcurementProject/cbc:Description_ in alignment with *eForms*.
** _cac:ProcurementProjectLot_ 
*** _Component_: removed because it is replaced by _cac:TenderingCriterion/cac:ProcurementProjectLotReference_.
