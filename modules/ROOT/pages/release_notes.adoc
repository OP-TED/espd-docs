...
link:{url-blob-202}/dist/cl/ods/ESPD-CriteriaTaxonomy-SELFCONTAINED-V2.0.2.ods[SELF-CONTAINED] flavours.
...
See also details in: link:++{url-blob}/dist/rn/Release Notes-2.1.0.ods++[Release Notes Details] and in this Github "Issues" section.
