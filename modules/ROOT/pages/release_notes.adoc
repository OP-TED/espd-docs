...
=== Code list
EU Vocabularies code lists version updated (specific files can be found in folder link:https://github.com/OP-TED/ESPD-EDM/tree/v3.1.0/codelists/gc[codelists/gc])
