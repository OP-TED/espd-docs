...
link:{url-blob-211}/dist/cl/xlsx/ESPD-CodeLists-V2.1.1.xlsx[ESPD-CodeLists-V2.1.1.xlsx].

* New code `QUAL_IDENTIFIER` has been added to
link:{url-blob-211}/dist/cl/xlsx/ESPD-CodeLists-V2.1.1.xlsx[ResponseDataType] Code List,
...
link:{url-blob-211}/dist/cl/xlsx/ESPD-CodeLists-V2.1.1.xlsx[QualificationApplicationType] Code List.

* Missing Canonical Version URI and Location URI have been added to
link:{url-blob-211}/dist/cl/xlsx/ESPD-CodeLists-V2.1.1.xlsx[WeightingType] Code List.

The code lists can be downloaded as an
link:{url-blob-211}/dist/cl/xlsx/ESPD-CodeLists-V2.1.1.xlsx[MS-Excel] or as an
link:{url-blob-211}/dist/cl/ods/ESPD-CodeLists-V2.1.1.ods[ODS file]. The list
...
link:{url-tree}/dist/cl/gc[GC folder].
...
creation reason, please refer to the following link:{url-blob-211}/assets/new_UUIDs_for_eCertis.xlsx[document].
...
** link:{url-tree}/dist/doc/evolution/Annotations_Proposal[Examples]
related to the proposal on _how to decouple the GUI from the data structures_ in future versions of the ESPD-EDM;
** link:{url-tree}/dist/doc/evolution/StaticPropertyUUIDGeneration_Proposal[Examples]
...
** link:{url-tree}/dist/xml[Examples]
...
link:{url-blob-210}/dist/cl/xlsx/ESPD-CodeLists-V2.1.0.xlsx[ESPD-CodeLists-V2.1.0.xlsx].
This has facilitated the automated generation of the link:{url-blob-210}/dist/cl/gc/ESPD-CriteriaTaxonomy_V2.1.0.gc[ESPD-CriteriaTaxonomy]
Genericode instance with the UUIDs and Codes of each criterion. The code lists can be downloaded as an
link:{url-blob-210}/dist/cl/xlsx/ESPD-CodeLists-V2.1.0.xlsx[MS-Excel] or as an
link:{url-blob-210}/dist/cl/ods/ESPD-CodeLists-V2.1.0.ods[ODS file]. The list
...
link:{url-blob-210}/dist/cl/xlsx/ESPD-CodeLists-V2.1.0.xlsx[ResponseDataType]
...
link:{url-blob-210}/dist/cl/xlsx/ESPD-CodeLists-V2.1.0.xlsx[EOIDType] code list).
...
link:{url-blob-210}/dist/cl/xlsx/ESPD-CodeLists-V2.1.0.xlsx[EORoleType].
...
link:{url-blob-210}/dist/cl/xlsx/ESPD-CriteriaTaxonomy-REGULATED-V2.1.0.xlsx[ESPD-CriteriaTaxonomy-REGULATED spread-sheet].
...
link:{url-blob-210}/dist/cl/xlsx/ESPD-CriteriaTaxonomy-SELFCONTAINED-V2.1.0.xlsx[ESPD-CriteriaTaxonomy-SELFCONTAINED spread-sheet]).
...
link:{url-blob-210}/dist/cl/xlsx/ESPD-CriteriaTaxonomy-SELFCONTAINED-V2.1.0.xlsx[spread-sheet]
tab ''SC-References'')
...
link:{url-blob-210}/dist/cl/xlsx/ESPD-CriteriaTaxonomy-SELFCONTAINED-V2.1.0.xlsx[Criteria Taxonomy]
...
the link:{url-blob-202}/dist/cl/ods/ESPD-CriteriaTaxonomy-REGULATED-V2.0.2.ods[REGULATED] and the
link:{url-blob-202}/dist/cl/ods/ESPD-CriteriaTaxonomy-SELFCONTAINED-V2.0.2.ods[SELF-CONTAINED] models.
...
The changes specified herein have been applied in both (1) the link:++https://github.com/ESPD/ESPD-EDM++[ESPD-EDM specification], version 2.1.1 published in this Github repository; and (2) the link:++http://wiki.ds.unipi.gr/display/ESPDInt/BIS+41+-+ESPD+V2.1.0++[ESPDInt BIS document].

See also details in: link:{url-blob}dist/rn/Release%20Notes-2.1.1.ods[Release Notes Details] and in this Github "Issues" section.
