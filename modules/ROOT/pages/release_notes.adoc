...
The ESPD-EDM version 4.4.0 focuses also on correcting other minor errors in the data structure and the codelists.   
 ...
 * **Fix Jira issue - "Update criterion files with codes of EU Vocabularies for v4.4.0**
...
* **Updating attributes values in the xslt files for the xml samples** 
        ** SchemeVersionID value is “4.4.0” and not “3.2.0”.
        ** ListVersionID value is “4.4.0” and not “3.2.0”. 
...
ESPD version has been updated in the technical codelist files to match the current version (specific files can be found in the folder https://github.com/OP-TED/ESPD-EDM/tree/v4.4.0/codelists/gc[codelists/gc]), for tags: Version, CanonicalURI, CanonicalVersionURI, LocationURI. 

The label "ESPD-EDMv4.4.0" has been added in the related sheet "ProfileExecutionID" (in the last row of the table) of the excel file https://github.com/OP-TED/ESPD-EDM/blob/master/\_\_ESPDTeam\_\_/ESPD-CodeLists.xlsx[ESPD-CodeLists.xlsx] . 
...
* Generating the ESPD validator, for the Request and the Response, for v4.4.0 with the latest entry files (generic code files for codelists, xml files for the ESPD Request and the ESPD Response). 
...
The Readme file for v4.4.0 has been updated as well. 
