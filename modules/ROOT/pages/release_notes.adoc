...
*** Type: updated from _Text_ to _Class_.
...
** _cac:ProcurementProjectLot_ 
*** _Cardinality_: updated from _0..1_ to _1..n_ according to _Figure 193. ESPD-EDM 'QualificationApplicationResponse', UML diagram._.
** _cbc:ProcedureCode_ 
*** _Cardinality_: updated from _0..1_ to _1_ according to _Figure 193. ESPD-EDM 'QualificationApplicationResponse', UML diagram._. 
*** _Type_: updated from _Identifier_ to _Code_.
** _cbc:ProfileExecutionID_ 
...
*** Cardinality: updated from _0..n_ to _0..1_.
...
*** _Component_: replaced by _cac:IssuerParty/cac:Party/cac:PartyName/cbc:Name_.
