...
link:{attachmentsdir}/dist/cl/xlsx/ESPD-CodeLists-V2.1.0.xlsx[PropertyGroupType]
...
link:{disturl}/dist/doc/evolution/Annotations%20Proposal[Annotations Proposal]
