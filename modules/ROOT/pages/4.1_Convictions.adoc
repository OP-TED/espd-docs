...
. Compulsory name and description for the criterion as defined in e-Certis. See also link:{url-blob}/dist/cl/ods/[ESPD-criterion-V3.0.0 spreadsheet]. Beware that UBL-2.3 allows '0..n' description lines!
