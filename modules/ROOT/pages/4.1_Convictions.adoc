...
<!-- Criterion:Participation in a criminal organisation -->
        <cac:TenderingCriterion>
                ...
                <cbc:CriterionTypeCode listID="criterion" listAgencyID="OP" listVersionID="20210616-0">crime-org</cbc:CriterionTypeCode>
...
. Compulsory name and description for the criterion as defined in e-Certis. See also link:{url-tree-tmp}/codelists/ESPD-criterion.xlsx[ESPD-criterion spreadsheet]. Beware that UBL-2.3 allows '0..n' description lines!
. This property is a caption, a mere 'label'. See Code List link:{url-tree-tmp}/codelists/gc/CriterionElementType.gc[CriterionElementType] for the complete list of possible options. Beware that when a property is of type CAPTION the cbc:ValueDataType must be set to NONE.
