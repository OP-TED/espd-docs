...
. This property is a caption, a mere 'label'. See Code List link:{distUrl}/dist/cl/ods/['CriterionElementType'] for the complete list of possible options. Beware that when a property is of type CAPTION the cbc:ValueDataType must be set to NONE.
