...
*Namespace prefixes* are used in XML to avoid element name conflicts. See the https://www.w3schools.com/XML/xml_namespaces.asp[W3schools definition and description].
