...
All the semantic assets needed to implement ESPD electronic documents are organised in a link:{url-tree}[distribution package]. https://github.com/OP-TED/ESPD-EDM/tree/v3.0.1[(dp)]The content of this folder is organised as follows:
