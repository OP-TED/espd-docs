...
All the semantic assets needed to implement ESPD electronic documents are organised in a link:{url-tree-tmp}[distribution package]. The content of this folder is organised as follows:
...
. *data-model*: contains the UML Data Model of the ESPD in .eap, .xmi and HTML format.
