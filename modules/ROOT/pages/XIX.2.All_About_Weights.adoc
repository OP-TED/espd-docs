...
link:{url-blob}/dist/cl/ods/ESPD-CodeLists-V2.1.1.ods[EvaluationMethodType] as
...
link:{url-blob}/dist/xml/Weights-Extended-Request_V2.1.1.xml[Weights-Extended-Request_V2.1.1.xml]_*
====
...
link:{url-blob}/dist/cl/xlsx/ESPD-CodeLists-V2.1.1.xlsx[EvaluationMethodType]
