...
link:{url-blob-202}/dist/cl/xlsx/ESPD-CodeLists-V2.0.2.xlsx[EvaluationMethodType] as
...
link:{url-blob}/dist/xml/Weights-SelfContained-Request_V2.1.0.xml[Weights-SelfContained-Request_V2.1.0.xml]_*
====
...
link:{url-blob}/dist/cl/xlsx/ESPD-CodeLists-V2.1.0.xlsx[EvaluationMethodType]
