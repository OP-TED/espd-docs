...
link:{distUrlBlob202}/dist/cl/xlsx/ESPD-CodeLists-V2.0.2.xlsx[EvaluationMethodType] as
...
link:{attachmentsdir}/dist/xml/Weights-SelfContained-Request_V2.1.0.xml[Weights-SelfContained-Request_V2.1.0.xml]_*
====
...
link:{attachmentsdir}/dist/cl/xlsx/ESPD-CodeLists-V2.1.0.xlsx[EvaluationMethodType]
...
link:{disturl}/dist/xml[dist/xml]._*
