...
[cols=",",]
|===
|*REQUIREMENT* pass:macros[http://wiki.ds.unipi.gr/display/ESPDInt/BIS+41+-+ESPD+V2.0.1[tbr092-015\]], pass:macros[http://wiki.ds.unipi.gr/display/ESPDInt/BIS+41+-+ESPD+V2.0.1[br41-002\]] |*The contracting body shall provide the exclusion grounds and selection criteria for its tendering process as structured information - via ESPD template or structured list of criteria set out in a call for tender.*
|===
...
include::4.1_Convictions.adoc[leveloffset=+1]
include::4.2_Contributions.adoc[leveloffset=+1]
include::4.3_Environment_Social_Labour_Law.adoc[leveloffset=+1]
include::4.4_Business.adoc[leveloffset=+1]
include::4.5_Misconduct.adoc[leveloffset=+1]
include::4.6_Conflict_of_interest.adoc[leveloffset=+1]
include::4.7_Early_termination.adoc[leveloffset=+1]
include::4.8_Misinterpretation.adoc[leveloffset=+1]
include::4.9_Purely_national_criteria.adoc[leveloffset=+1]