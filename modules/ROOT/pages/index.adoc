...
The documentation provided here explains the ESPD Exchange Data Model (ESPD-EDM) and covers the resources provided by the Publications Office, to help member states and commercial entities create an ESPD service. The service is the practical online form which enables both parties in a procurement procedure to manage eligibility of a supplier electronically.
...
* xref:3.0.0@ESPD:ROOT:release_notes.adoc[Release Notes] +
...
* xref:ESPD:business:index.adoc[Business Information] +
