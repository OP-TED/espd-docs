...
* The selection criteria apply per lot i.e., they may be different between lots.
...
Each section of the ESPD form is filled in by one or both parties, and in the case of a response involving an offering group, the group leader must fill in information related to group members in the response.
